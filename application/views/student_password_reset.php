...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>Assest/student_password_reset.css">
    </head>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-12 text-center header">
                <h1> <strong>  পরীক্ষার্থীর পাসওয়ার্ড পুনরুদ্ধার</strong></h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="login_form">
                <div class="col-lg-6 col-lg-offset-3">
                    <form action="<?php echo base_url(); ?>main/student_password_reset_confirm" method="POST" class="form-horizontal" role="form" id="form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 help-block">                                    
                                    <a href="<?php echo base_url(); ?>main/student_login"> লগইন করুন </a>
                                </div>
