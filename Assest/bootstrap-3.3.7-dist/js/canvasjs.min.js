...
(function () {
    ...
    function G(a) {
        var d = ((a & 16711680) >> 16).toString(16), b = ((a & 65280) >> 8).toString(16);
    ...
    function Ra(a, d) {
        var b = this.length >>> 0, c = Number(d) ||
                0, c = 0 > c ? Math.ceil(c) : Math.floor(c);
        for (0 > c && (c += b); c < b; c++)
        ...
        if (isNaN(f)) {
            try {
                ...
                if (!ba) {
                    ...
                    ba.innerHTML = "";
                    var h = document.creপccateTextNode("Mpgyi");
                    ba.appendChild(h);
                    g.appendChild(ba)
                }
                ba.style.display = "";
    ...
    function K(a, d, b, c) {
        if (a.addEventListener)
            a.addEventListener(d, b, c || !1);
        else if (a.attachEvent)
            a.attachEvent("on" + d, function (c) {
                c = c || window.event;
    ...
    function Sa(a) {
        if (!Aa) {
            ...
            if (a.creditHref && a.creditText) {
                ...
                if (0 === a.renderCount || d || b)
                    a._creditLink.setAttribute("href", a.creditHref), a._creditLink.innerHTML = a.creditText;
    ...
    function Ba(a, d, b) {
        if (a && d && b) {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                for (var h = a.replace(/^data:[a-z/]*;base64,/, ""), h = atob(h), l = new ArrayBuffer(h.length), l = new Uint8Array(l), k = 0; k < h.length; k++)
                    l[k] = h.charCodeAt(k);
    ...
    function ta() {
        for (var a = null, d = 0; d < arguments.length; d++)
            a = arguments[d], a.style && (a.style.display = "inline")
    }
    function Y() {
        for (var a = null, d = 0; d < arguments.length; d++)
            (a = arguments[d]) &&
    ...
    function A(a, d) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            var c = 0, f = 0, c = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, f = this.options.height ? this.height :
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Qa(this.ctx), u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ga(c, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                b._updateSize() && b.render()
                    ...
                    "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {x1: 0, y1: 0, x2: this.width, y2: this.height}, K(this.overlaidCanvas, "click", function (a) {
                ...
                b._touchEventHandler(a)
                    ...
                    new S(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {axisX: [], axisX2: [], axisY: [], axisY2: []})
        } else
        ...
        for (var b = [], c, f = 0; f < a.length; f++)
            if (0 == f)
                ...
                var k =
                        (a[h].x - a[g].x) / c;
                c = (a[h].y - a[g].y) / c;
                b[b.length] = a[l].x > a[g].x && 0 < k || a[l].x < a[g].x && 0 > k ? {x: a[l].x + k / 3, y: a[l].y + c / 3} : {x: a[l].x, y: a[l].y + c / 9};
                l = f;
                g = 0 === l ? 0 : l - 1;
                h = l === a.length - 1 ? l : l + 1;
    ...
    function B(a, d, b, c, f) {
        ...
        if (this.options.stripLines && 0 < this.options.stripLines.length)
            for (this.stripLines = [], d = 0; d < this.options.stripLines.length; d++)
                this.stripLines.push(new na(this.chart, this.options.stripLines[d], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var z = {}, u = !!document.createElement("canvas").getContext, ca = {Chart: {width: 500, height: 400, zoomEnabled: !1, zoomType: "x", backgroundColor: "white", theme: "theme1", animationEnabled: !1, animationDuration: 1200,
        ...
        colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")}, ia = {theme1: {Chart: {colorSet: "colorSet1"}, Title: {fontFamily: u ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5}, Subtitle: {fontFamily: u ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top",
                ...
                titleFontFamily: u ? "Verdana, Geneva, Calibri, sans-serif" : "calibri", labelFontFamily: u ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", labelFontSize: 18, labelFontColor: "grey", tickColor: "grey", tickThickness: 2, gridThickness: 2, gridColor: "grey", lineThickness: 2, lineColor: "grey"}, Legend: {verticalAlign: "bottom", horizontalAlign: "center", fontFamily: u ? "monospace, sans-serif,arial black" : "calibri"}, DataSeries: {bevelEnabled: !0, indexLabelFontColor: "grey", indexLabelFontFamily: u ? "Candara, Optima, Calibri, Verdana, Geneva, sans-serif" :
                        "calibri", indexLabelFontSize: 18, indexLabelLineColor: "lightgrey", indexLabelLineThickness: 2}}}, E = {numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")}, Ka = {}, ba = null, Ea = function () {
        var a = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, d = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
                b = "Sun Mon Tue Wed Thu Fri Sat".split(" "), c = "January February March April May June July August September October November December".split(" "), f = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), g = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, h = /[^-+\dA-Z]/g;
        return function (l, k, n) {
            var m = n ? n.days : d, p = n ? n.months : c, e = n ? n.shortDays : b, q = n ? n.shortMonths : f;
            n = "";
            var r = !1;
            l = l && l.getTime ? l : l ? new Date(l) : new Date;
            if (isNaN(l))
                throw SyntaxError("invalid date");
            "UTC:" === k.slice(0, 4) && (k = k.slice(4), r = !0);
            n = r ? "getUTC" : "get";
            var s = l[n + "Date"](), v = l[n + "Day"](), w = l[n + "Month"](), y = l[n + "FullYear"](), t = l[n + "Hours"](), u = l[n + "Minutes"](), Z = l[n + "Seconds"](), aa = l[n + "Milliseconds"](), x = r ? 0 : l.getTimezoneOffset();
            return n = k.replace(a, function (a) {
                switch (a) {
                    ...
                    case "YY":
                        return P(String(y).slice(-2), 2);
                    case "YYY":
                        return P(String(y).slice(-3), 3);
                    case "YYYY":
                        return P(y, 4);
                    case "h":
                        return t % 12 || 12;
                    ...
                    case "ff":
                        return P(String(aa).slice(0, 2), 2);
                    case "fff":
                        return P(String(aa).slice(0, 3), 3);
                    case "t":
                        return 12 > t ? "a" : "p";
                    case "tt":
                        return 12 >
                    ...
                    case "TT":
                        return 12 > t ? "AM" : "PM";
                    case "K":
                        return r ? "UTC" : (String(l).match(g) || [""]).pop().replace(h, "");
                    case "z":
                        return(0 < x ? "-" : "+") + Math.floor(Math.abs(x) / 60);
                    case "zz":
                        return(0 < x ? "-" : "+") + P(Math.floor(Math.abs(x) / 60), 2);
                    case "zzz":
                        return(0 < x ? "-" : "+") + P(Math.floor(Math.abs(x) / 60), 2) + P(Math.abs(x) % 60, 2);
                    default:
        ...
        var f = b ? b.decimalSeparator : ".", g =
                b ? b.digitGroupSeparator : ",", h = "";
        d = String(d);
        var h = 1, l = b = "", k = -1, n = [], m = [], p = 0, e = 0, q = 0, r = !1, s = 0, l = d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        d = null;
        for (var v = 0; l && v < l.length; v++)
            if (d = l[v], "." === d && 0 > k)
                ...
                if ("%" === d)
                    ...
                    "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || (r = !0);
                0 > k ? (n.push(d), "#" === d || "0" === d ? p++ : "," === d && q++) : (m.push(d), "#" !== d &&
                        "0" !== d || e++)
            }
        r && (d = Math.floor(a), s = 0 === a ? "" : (0 === d ? "" : String(d)).length - p, h /= Math.pow(10, s));
        0 > k && (k = v);
        h = (a * h).toFixed(e);
        d = h.split(".");
        h = (d[0] + "").split("");
        a = (d[1] + "").split("");
        h && "0" === h[0] && h.shift();
        for (v = r = l = e = k = 0; 0 < n.length; )
            if (d = n.pop(), "#" === d || "0" === d)
                if (k++, k === p) {
                    var w = h, h = [];
                    if ("0" === d)
                        for (d = p - e - (w?w.length:0); 0 < d; )
                            w.unshift("0"), d--;
                    for (; 0 < w.length; )
                        b = w.pop() + b, v++, 0 === v % r && (l === q && 0 < w.length) && (b = g + b);
                    c && (b = "-" + b)
                } else
                    0 < h.length ? (b = h.pop() + b, e++, v++) : "0" === d && (b = "0" + b, e++, v++),
                            0 === v % r && (l === q && 0 < h.length) && (b = g + b);
            else
                "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (l++, r = v, v = 0, 0 < h.length && (b = g + b)) : b = 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? d.slice(1, d.length - 1) + b : d + b : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), b += d.replace(/[0]+/, function (a) {
                    return P(s, a.length)
                }));
        c = "";
        for (g = !1; 0 < m.length; )
            d = m.shift(), "#" === d || "0" === d ? 0 < a.length && 0 !== Number(a.join("")) ? (c += a.shift(), g = !0) : "0" === d && (c +=
                    "0", g = !0) : 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? c += d.slice(1, d.length - 1) : "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? c += d : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), c += d.replace(/[0]+/, function (a) {
                return P(s, a.length)
            }));
        return b + ((g ? f : "") + c)
    }, xa = function (a) {
    ...
    (function () {
        z.fSDec = function (a) {
            for (var d = "", b = 0; b < a.length; b++)
                d += String.fromCharCode(a[b] - 111);
            return d
        };
        z.str = {tv: [195, 225, 216, 208, 219, 143, 197, 212, 225,
        ...
        delete ca[z.fSDec([178,
            215, 208, 225, 227])][z.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
        z.pro = {sCH: ca[z.fSDec([178, 215, 208, 225, 227])][z.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])]};
        z.fAWm = function (a) {
        ...
        z.fNg = function (a) {
            if (!Aa)
                try {
                    var d;
                    a:{
                        var b = RegExp(z.ckDec(z.str.ckn) + "=.*", "gi"), c = new Date, f = document.cookie.match(b), g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(z.ckDec(z.str.ckn)) ? JSON.parse(localStorage.getItem("lclStg")) :
                                null;
                        if (f && 0 < f.length || g) {
                            var h, b = [], l = [], k = null;
                            if (f)
                                for (var n = f[0].split("; "), f = 0; f < n.length; f++)
                                    b.push(n[f].split("=")[0]), l.push(n[f].split("=")[1]);
                            g && (k = g);
                            h = {ckVal: Number(l[0]), lSVal: k ? Number(k.val) : null};
                            g = null;
                            ...
                            k = l.getTime();
                            l.setTime(k + 31536E6);
                            var m = {name: z.ckDec(z.str.ckn), val: (new Date).getTime()};
                            document.cookie = z.ckDec(z.str.ckn) +
                                    "=" + (new Date).getTime() + "; " + z.ckDec(z.str.ckve) + l.toUTCString() + "; path=/;";
                            localStorage.setItem("lclStg", JSON.stringify(m))
                        }
                        d = !1
                    }
                    if (d) {
                        ...
                        var e = z.ckDec(z.str.tem), q = p.measureText(e).width;
                        p.fillStyle = u ? z.ckDec(z.str.mco) : z.ckDec(z.str.mcw);
                        p.fillRect(a.plotArea.x2 - q - 8, a.plotArea.y2 - 2.5 * d - 8, q + 4, 2.5 * d + 8);
                        p.fillStyle = u ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                        p.textBaseline =
                                "top";
                        p.fillText(e, a.plotArea.x2 - q - 4, a.plotArea.y2 - 2.5 * d - 2);
                        d = 14;
                        p.font = d + (u ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                        e = z.ckDec(z.str.ctm);
                        q = p.measureText(e).width;
                        p.fillStyle = u ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                        p.fillText(e, a.plotArea.x2 - q - 4, a.plotArea.y2 - 2 * d - 4);
                        e = z.ckDec(z.str.ltm);
                        q = p.measureText(e).width;
                        p.fillText(e, a.plotArea.x2 - q - 4, a.plotArea.y2 - d - 4)
                    }
                } catch (r) {
                }
        }
    ...
    M.prototype.setOptions = function (a, d) {
        if (ca[this._defaultsKey]) {
            var b =
                    ca[this._defaultsKey], c;
            for (c in b)
                "publicProperties" !== c && b.hasOwnProperty(c) && (this[c] = a && c in a ? a[c] : d && c in d ? d[c] : b[c])
        }
    };
    M.prototype.get = function (a) {
        ...
        if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a))
            return this[a];
    ...
    M.prototype.set = function (a, d, b) {
        ...
        if ("options" === a)
            this.createUserOptions(d);
        else if (c.hasOwnProperty(a) || c.publicProperties && c.publicProperties.hasOwnProperty(a) && "readWrite" === c.publicProperties[a])
            this.options._isPlaceholder && this.createUserOptions(), this.options[a] = d;
        else {
    ...
    M.prototype.createUserOptions = function (a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                var d =
                        this.parent.options[this.optionsName], b = d.length;
                this.options._isPlaceholder || (qa(d), b = d.indexOf(this.options));
                this.options = "undefined" === typeof a ? {} : a;
                d[b] = this.options
            } else
                this.options = "undefined" === typeof a ? {} : a, a = this.parent.options, this.optionsName ? d = this.optionsName : (d = this._defaultsKey) && 0 !== d.length ? (b = d.charAt(0).toLowerCase(), 1 < d.length && (b = b.concat(d.slice(1))), d = b) : d = void 0, a[d] = this.options
    };
    ...
    M.prototype.updateOption = function (a) {
        var d = ca[this._defaultsKey], b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ? this.chart.options.theme : "theme1", c = {}, f = this[a];
    ...
    M.prototype.addEventListener =
            function (a, d, b) {
                a && d && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({context: b || this, eventHandler: d}))
            };
    ...
    M.prototype.dispatchEvent = function (a, d, b) {
        if (a && this._eventListeners[a]) {
            ...
            for (var c = this._eventListeners[a],
                    f = 0; f < c.length; f++)
                c[f].eventHandler.call(c[f].context, d)
        }
    ...
    A.prototype._updateOptions = function () {
                        ...
                        "click", function () {
                            ...
                            if (a.sessionVariables.axisX2)
                                for (b = 0; b < a.sessionVariables.axisX2.length; b++)
                                    a.sessionVariables.axisX2[b].newViewportMinimum =
        ...
        for (var b in this.toolTip.options)
            this.toolTip.options.hasOwnProperty(b) &&
    ...
    A.prototype.render = function (a) {
                    ...
                    if (this.options.axisY && 0 < this.options.axisY.length) {
                        if (!this.axisY.length)
                            for (var b = 0; b < this.options.axisY.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new B(this, this.options.axisY[b], "axisY", "left", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[b] = new B(this, this.options.axisY[b], "axisY", "bottom", b));
                    ...
                    if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                        if (!this.axisY2.length)
                            for (b = 0; b < this.options.axisY2.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "right", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new B(this, this.options.axisY2[b], "axisY", "top", b));
                    ...
                    if (this.options.axisX && 0 < this.options.axisX.length) {
                        if (!this.axisX.length)
                            for (b = 0; b < this.options.axisX.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new B(this, this.options.axisX[b], "axisX", "bottom", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[b] = new B(this, this.options.axisX[b], "axisX", "left", b));
                    ...
                    if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                        if (!this.axisX2.length)
                            for (b = 0; b < this.options.axisX2.length; b++)
                                "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b], "axisX", "top", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new B(this, this.options.axisX2[b], "axisX", "right", b));
        ...
        if (this.options.subtitles)
            for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)
                b = new va(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? d.push(b) : b.render();
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
            B.setLayoutAndRender(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
        else if ("none" ===
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var d = this.plotInfo.plotTypes[a], g = 0; g < d.plotUnits.length; g++) {
                ...
                for (b = 0; b < h.dataSeriesIndexes.length; b++)
                    this._dataInRenderedOrder.push(this.data[h.dataSeriesIndexes[b]]);
        ...
        0 < c.length ? (k.disableToolTip = !0, k._animator.animate(200, k.animationDuration, function (a) {
            ...
            for (var b = 0; b < c.length; b++)
                l = c[b], 1 > a && "undefined" !== typeof l.startTimePercent ? a >= l.startTimePercent && l.animationCallback(l.easingFunction(a - l.startTimePercent, 0, 1, 1 - l.startTimePercent), l) : l.animationCallback(l.easingFunction(a, 0, 1, 1), l);
            k.dispatchEvent("dataAnimationIterationEnd", {chart: k})
        }, function () {
            c = [];
            for (var a = 0; a < k.plotInfo.plotTypes.length; a++)
                for (var b = k.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++)
                    b.plotUnits[d].targetCanvas =
                            null;
            f = null;
            k.disableToolTip = !1
        })) : (0 < k._indexLabels.length && k.renderIndexLabels(), k.dispatchEvent("dataAnimationIterationEnd", {chart: k}));
    ...
    A.prototype.categoriseDataSeries = function () {
        for (var a = "", d = 0; d < this.data.length; d++)
            if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= A._supportedChartTypes.indexOf(a.type)) {
                ...
                g || (f = {type: a.type, previousDataSeriesCount: 0, index: b.plotUnits.length, plotType: b, axisXType: a.axisXType, axisYType: a.axisYType, axisYIndex: a.axisYIndex, axisXIndex: a.axisXIndex, axisY: "primary" ===
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++)
            for (b =
                    this.plotInfo.plotTypes[d], h = a = 0; h < b.plotUnits.length; h++)
    ...
    A.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = this.data[a.dataSeriesIndexes[h]], k = 0, n = !1, m = !1, p;
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
                    var e = a.axisX.sessionVariables.newViewportMinimum ?
                ...
                if (l.dataPoints[k].x && l.dataPoints[k].x.getTime || "dateTime" === l.xValueType)
                    g = !0;
                for (k = 0; k < l.dataPoints.length; k++) {
                    ...
                    if (0 < k) {
                        if (a.axisX.logarithmic) {
                            var r = c / l.dataPoints[k - 1].x;
                            1 > r && (r = 1 / r);
                            b.minDiff > r && 1 !== r && (b.minDiff = r)
                        } else
                            r = c - l.dataPoints[k -
                            1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
                        null !== f && null !== l.dataPoints[k - 1].y && (a.axisY.logarithmic ? (r = f / l.dataPoints[k - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = f - l.dataPoints[k - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                    }
                    if (c < e && !n)
                        null !== f && (p = c);
                    else {
    ...
    A.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], p = 0, e = !1, q = !1, r;
                if ("normal" === m.axisPlacement || "xySwapped" ===
                        m.axisPlacement)
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                            ...
                            w = c - m.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w);
                        null !== f && null !== m.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < f && (w = f / m.dataPoints[p - 1].y, 1 > w && (w = 1 / w), d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = f - m.dataPoints[p - 1].y, 0 > w && (w *= -1), d.minDiff > w && 0 !== w && (d.minDiff = w)))
                    }
                    if (c < s && !e)
                        null !== m.dataPoints[p].y && (r = c);
                    else {
                        if (!e && (e = !0, 0 < p)) {
                            p -= 2;
                            continue
                        ...
                        c < b.viewPortMin && (b.viewPortMin = c);
                        c > b.viewPortMax && (b.viewPortMax = c);
                        null === m.dataPoints[p].y ? b.viewPortMin === c && r < c && (b.viewPortMin = r) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f), 0 <= f ? h[c] = h[c] ? h[c] + f : f : l[c] = l[c] ? l[c] + f : f)
                    }
                }
                this.plotInfo.axisXValueType = m.xValueType = g ? "dateTime" : "number"
            }
            for (p in h)
                h.hasOwnProperty(p) && !isNaN(p) && (a = h[p], a < d.min && (d.min = Math.min(a, k)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, k)), a > d.viewPortMax &&
                        (d.viewPortMax = a)));
            for (p in l)
                l.hasOwnProperty(p) && !isNaN(p) && (a = l[p], a < d.min && (d.min = Math.min(a, k)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, k)), a > d.viewPortMax && (d.viewPortMax = a)))
        }
    };
    A.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = !1, l = !1, k = [], n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], p = 0,
                        e = !1, q = !1, r;
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                            var w = c / m.dataPoints[p -
                            1].x;
                            1 > w && (w = 1 / w);
                            b.minDiff > w && 1 !== w && (b.minDiff = w)
                        } else
                            w = c - m.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w);
                        x(f) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < f && (w = f / m.dataPoints[p - 1].y, 1 > w && (w = 1 / w), d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = f - m.dataPoints[p - 1].y, 0 > w && (w *= -1), d.minDiff > w && 0 !== w && (d.minDiff = w)))
                    }
                    if (c < s && !e)
                        null !== f && (r = c);
                    else {
                        ...
                        c < b.viewPortMin && (b.viewPortMin = c);
                        c > b.viewPortMax && (b.viewPortMax = c);
                        null === f ? b.viewPortMin === c && r < c && (b.viewPortMin = r) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f), 0 <= f ? h = !0 : 0 > f && (l = !0), k[c] = k[c] ? k[c] + Math.abs(f) : Math.abs(f))
                    }
                }
                this.plotInfo.axisXValueType = m.xValueType = g ? "dateTime" : "number"
            }
    ...
    A.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d =
                ...
                var n = this.data[a.dataSeriesIndexes[k]], m = 0, p = !1, e = !1, q, r, s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
                    var v = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, w = this.sessionVariables.axisX.newViewportMaximum ?
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    g < d.min && (d.min = g);
                    h > d.max && (d.max = h);
                    0 < m && (a.axisX.logarithmic ? (r = c / n.dataPoints[m - 1].x, 1 > r && (r = 1 / r), b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = c - n.dataPoints[m - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r)), f && (null !== f[0] && n.dataPoints[m - 1].y && null !== n.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = f[0] /
                            n.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = f[0] - n.dataPoints[m - 1].y[0], 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r))));
                    if (!(c < v) || p) {
                        if (!p && (p = !0, 0 < m)) {
                            m -= 2;
                            q = s;
                        ...
                        null === f ? b.viewPortMin === c && q < c &&
                                (b.viewPortMin = q) : (g < d.viewPortMin && (d.viewPortMin = g), h > d.viewPortMax && (d.viewPortMax = h))
                    }
                }
    ...
    A.prototype.getObjectAtXY = function (a, d, b) {
        ...
        if (b = this.getDataPointAtXY(a, d, b || !1))
            ...
            c = La(a, d, this._eventManager.ghostCtx);
        else
    ...
    A.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            var d = [], b = a.changedTouches, c = b ? b[0] : a, f = null;
            switch (a.type) {
                case "touchstart":
                case "MSPointerDown":
            ...
            if (!(b && 1 < b.length)) {
                ...
                f.time = new Date;
                try {
                    var g = f.y - this._lastTouchData.y, h = f.time - this._lastTouchData.time;
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled)
                    ...
                    for (b = 0; b < d.length; b++)
                        f = d[b], g = document.createEvent("MouseEvent"),
        ...
        for (var f = 0; f < c.length; f++)
            if (x(b[c[f]]) && (b[c[f]] = []), "axisY" === c[f])
                for (var g = 0; g < this.axisY.length; g++)
                    b[c[f]].push({viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum});
            else if ("axisY2" === c[f])
                for (g = 0; g < this.axisY2.length; g++)
                    b[c[f]].push({viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum});
            else if ("axisX" === c[f])
                for (g = 0; g < this.axisX.length; g++)
                    b[c[f]].push({viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum,
                    ...
                    for (var g = 0; g < this._events.length; g++)
                        if (this._events[g].hasOwnProperty(b))
                            if (c = this._events[g], f = c.bounds, d.x >= f.x1 && d.x <= f.x2 && d.y >= f.y1 && d.y <= f.y2) {
                                ...
                                "mousedown" === b && !0 === c.capture ? (A.capturedEventParam = c, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler,
                                        !1)) : "mouseup" === b && (c.chart.overlaidCanvas.releaseCapture ? c.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                break
                            } else
                                c = null;
    ...
    A.prototype._plotAreaMouseUp = function (a, d) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            var b = d - this.dragStartPoint.y, c = a - this.dragStartPoint.x, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = !1;
            this.resetOverlayedCanvas();
            if ("xySwapped" === this.plotInfo.axisPlacement)
                var l = g, g = f, f = l;
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    for (f = g = 0; f < this._axes.length; f++)
                        b =
    ...
    A.prototype._plotAreaMouseMove = function (a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, c = 0, f = b = null, f =
                    0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = this;
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled)
                    f = {x1: f ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + c : this.plotArea.y1,
                        x2: f ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + c : this.plotArea.y2}, clearTimeout(h._panTimerId), h._panTimerId = setTimeout(function (b, c, e, f) {
                        return function () {
                    ...
                    this.overlaidCanvasCtx.fillStyle =
                            "#A89896";
                    var c = f ? this.dragStartPoint.x : this.plotArea.x1, l = g ? this.dragStartPoint.y : this.plotArea.y1, k = f ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, n = g ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
    ...
    A.prototype._zoomPanToSelectedRegion = function (a, d, b, c, f) {
        ...
        if (a.isValid)
            for (c = 0; c < d.length; c++)
                f = b[c], d[c].setViewPortRange(f.val1, f.val2);
        return a.isValid
    };
    A.prototype.validateRegion = function (a, d, b, c, f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), l = !1, k = [], n = [], m = [], p = 0; p < this.axisX.length; p++)
            this.axisX[p] &&
                    g && n.push(this.axisX[p]);
        for (p = 0; p < this.axisX2.length; p++)
            this.axisX2[p] && g && n.push(this.axisX2[p]);
        for (p = 0; p < this.axisY.length; p++)
            this.axisY[p] && h && n.push(this.axisY[p]);
        for (p = 0; p < this.axisY2.length; p++)
            this.axisY2[p] && h && n.push(this.axisY2[p]);
        for (g = 0; g < n.length; g++) {
            var h = n[g], p = h.convertPixelToValue({x: a, y: d}), e = h.convertPixelToValue({x: b, y: c});
            if (p > e)
                var q = e, e = p, p = q;
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                        p < h.minimum || e > h.maximum))
                    k.push(h), m.push({val1: p, val2: e}), l = !0;
                else if (!f) {
                    l = !1;
                    break
                }
        }
        return{isValid: l, axesWithValidRange: k, axesRanges: m}
    };
    ...
    A.prototype.renderIndexLabels = function (a) {
        var d = a || this.plotArea.ctx, b = this.plotArea, c = 0, f = 0, g = 0, h = 0, l = c = h = f = g = 0, k = 0;
        for (a = 0; a < this._indexLabels.length; a++) {
            var n = this._indexLabels[a], m = n.chartType.toLowerCase(),
                    p, e, l = L("indexLabelFontColor", n.dataPoint, n.dataSeries), k = L("indexLabelFontSize", n.dataPoint, n.dataSeries);
            p = L("indexLabelFontFamily", n.dataPoint, n.dataSeries);
            e = L("indexLabelFontStyle", n.dataPoint, n.dataSeries);
            var h = L("indexLabelFontWeight", n.dataPoint, n.dataSeries), q = L("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), f = L("indexLabelMaxWidth", n.dataPoint, n.dataSeries), g = L("indexLabelWrap", n.dataPoint, n.dataSeries), r = L("indexLabelLineDashType", n.dataPoint, n.dataSeries), s = L("indexLabelLineColor",
                    n.dataPoint, n.dataSeries), v = x(n.dataPoint.indexLabelLineThickness) ? x(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, c = 0 < v ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, w = {percent: null, total: null}, y = null;
            if (0 <= n.dataSeries.type.indexOf("stacked") || "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type)
                w = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
            if (n.dataSeries.indexLabelFormatter ||
                    n.dataPoint.indexLabelFormatter)
                y = {chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: w.total, percent: w.percent};
            var t = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(y) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(y) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries,
                    null, n.indexKeyword) : null;
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", n.dataPoint, n.dataSeries), y = L("indexLabelOrientation", n.dataPoint, n.dataSeries), D = n.direction, Z = n.dataSeries.axisX, aa = n.dataSeries.axisY, z = !1, q = new W(d, {x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: g ? 5 * k : 1.5 * k, angle: "horizontal" === y ? 0 : -90, text: t, padding: 0, backgroundColor: q, horizontalAlign: "left", fontSize: k, fontFamily: p, fontWeight: h, fontColor: l, fontStyle: e, textBaseline: "top"});
                q.measureText();
                n.dataSeries.indexLabelMaxWidth =
                        q.maxWidth;
                if (0 <= m.indexOf("line") || 0 <= m.indexOf("area") || 0 <= m.indexOf("bubble") || 0 <= m.indexOf("scatter")) {
                    if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum || n.dataPoint.y < aa.viewportMinimum || n.dataPoint.y > aa.viewportMaximum)
                        continue
                } else if (0 <= m.indexOf("column")) {
                    if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum || n.bounds.y1 > b.y2 || n.bounds.y2 < b.y1)
                        continue
                } else if (0 <= m.indexOf("bar")) {
                    if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum || n.bounds.x1 >
                            b.x2 || n.bounds.x2 < b.x1)
                        continue
                } else if (n.dataPoint.x < Z.viewportMinimum || n.dataPoint.x > Z.viewportMaximum)
                    continue;
                f = h = 2;
                "horizontal" === y ? (l = q.width, k = q.height) : (k = q.width, l = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= m.indexOf("line") || 0 <= m.indexOf("area"))
                        ...
                        w = "inside";
                    p = n.point.x - l / 2;
                    "inside" !== w ? (f = b.y1, g = b.y2, 0 < D ? (e = n.point.y - k - h - c, e < f && (e = "auto" === w ? Math.max(n.point.y, f) + h + c :
                            ...
                            (e = Math.min(n.point.y + h, b.y2 - k - h))), e = Math.min(e, g - k))
                } else
                    0 <= m.indexOf("line") || 0 <= m.indexOf("area") || 0 <= m.indexOf("scatter") ? (w = "auto", f = 4) : 0 <= m.indexOf("stacked") ? "auto" === w && (w = "inside") : "bubble" === m && (w = "inside"), e = n.point.y - k / 2, "inside" !== w ? (h = b.x1, g = b.x2, 0 > D ? (p = n.point.x - l - f - c, p < h && (p = "auto" === w ? Math.max(n.point.x, h) + f + c : h + f + c, z = p + l > n.point.x)) : (p = n.point.x + f + c, p > g - l - f - c && (p = "auto" === w ? Math.min(n.point.x, g) - l - f - c : g - l - f - c, z = p < n.point.x))) : (h = Math.max(n.bounds.x1, b.x1), Math.min(n.bounds.x2,
                            b.x2), c = 0 <= m.indexOf("range") ? 0 > D ? Math.max(n.bounds.x1, b.x1) + l / 2 + f : Math.min(n.bounds.x2, b.x2) - l / 2 - f : (Math.max(n.bounds.x1, b.x1) + Math.min(n.bounds.x2, b.x2)) / 2, p = 0 > D ? Math.max(n.point.x, c) - l / 2 : Math.min(n.point.x, c) - l / 2, p = Math.max(p, h));
                "vertical" === y && (e += k);
                q.x = p;
                q.y = e;
                q.render(!0);
                v && ("inside" !== w && (0 > m.indexOf("bar") && n.point.x > b.x1 && n.point.x < b.x2 || !z) && (0 > m.indexOf("column") && n.point.y > b.y1 && n.point.y < b.y2 || !z)) && (d.lineWidth = v, d.strokeStyle = s ? s : "gray", d.setLineDash && d.setLineDash(I(r, v)), d.beginPath(),
                        d.moveTo(n.point.x, n.point.y), 0 <= m.indexOf("bar") ? d.lineTo(p + (0 < n.direction ? 0 : l), e + ("horizontal" === y ? k : -k) / 2) : 0 <= m.indexOf("column") ? d.lineTo(p + l / 2, e + ((0 < n.direction ? k : -k) + ("horizontal" === y ? k : -k)) / 2) : d.lineTo(p + l / 2, e + ((e < n.point.y ? k : -k) + ("horizontal" === y ? k : -k)) / 2), d.stroke())
            }
        }
        d = {source: d, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7};
        for (a = 0; a < this._indexLabels.length; a++)
            n = this._indexLabels[a], q = L("indexLabelBackgroundColor",
                    n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = x(q) ? u ? "transparent" : null : q;
        return d
    };
    A.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                var h = a.dataSeriesIndexes[g], l = this.data[h];
                d.lineWidth = l.lineThickness;
                var k = l.dataPoints, n = "solid";
                if (d.setLineDash) {
                    var m =
                            I(l.nullDataLineDashType, l.lineThickness), n = l.lineDashType, p = I(n, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                ...
                var e = l._colorSet, q = e = l.lineColor = l.options.lineColor ? l.options.lineColor : e[0];
                d.strokeStyle = e;
                var r = !0, s = 0, v, w;
                d.beginPath();
                if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++)
                        if (v = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof k[s].y)
                                0 < s && !(l.connectNullData || y || r) && (d.stroke(), u && b.stroke()), y = !0;
                            else {
                                v = a.axisX.convertValueToPixel(v);
                                w = a.axisY.convertValueToPixel(k[s].y);
                                var t = l.dataPointIds[s];
                                this._eventManager.objectMap[t] = {id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: s, x1: v, y1: w};
                                r || y ? (!r && l.connectNullData ? (d.setLineDash && (l.options.nullDataLineDashType || n === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (d.stroke(),
                                        n = l.nullDataLineDashType, d.setLineDash(m)), d.lineTo(v, w), u && b.lineTo(v, w)) : (d.beginPath(), d.moveTo(v, w), u && (b.beginPath(), b.moveTo(v, w))), y = r = !1) : (d.lineTo(v, w), u && b.lineTo(v, w), 0 == s % 500 && (d.stroke(), d.beginPath(), d.moveTo(v, w), u && (b.stroke(), b.beginPath(), b.moveTo(v, w))));
                                s < k.length - 1 && (q !== (k[s].lineColor || e) || n !== (k[s].lineDashType || l.lineDashType)) && (d.stroke(), d.beginPath(), d.moveTo(v, w), q = k[s].lineColor || e, d.strokeStyle = q, d.setLineDash && (k[s].lineDashType ? (n = k[s].lineDashType, d.setLineDash(I(n,
                                        l.lineThickness))) : (n = l.lineDashType, d.setLineDash(p))));
                                if (0 < k[s].markerSize || 0 < l.markerSize) {
                                    var D = l.getMarkerProperties(s, v, w, d), f = D.color;
                                    c.push(D);
                                    t = G(t);
                                    u && c.push({x: v, y: w, ctx: b, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness})
                                }
                                (k[s].indexLabel || l.indexLabel || k[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({chartType: "line", dataPoint: k[s], dataSeries: l, point: {x: v, y: w}, direction: 0 > k[s].y === a.axisY.reversed ? 1 : -1, color: e})
                            }
                    d.stroke();
                    u && b.stroke()
                }
            ...
            d.beginPath();
            u && b.beginPath();
            return{source: d, dest: this.plotArea.ctx, animationCallback: F.xClipAnimation, easingFunction: F.easing.linear, animationBase: 0}
        }
    };
    A.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var k = l.dataPoints, n = "solid";
                if (d.setLineDash) {
                    var m = I(l.nullDataLineDashType, l.lineThickness), n = l.lineDashType, p = I(n, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: h};
                    ...
                    for (var y =
                        ...
                        if (v = k[s].getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y)))
                            if ("number" !== typeof k[s].y)
                                ...
                                this._eventManager.objectMap[D] = {id: D, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: s, x1: v, y1: w};
                                r || y ? (!r && l.connectNullData ? (d.setLineDash &&
                                ...
                                s < k.length - 1 && (q !== (k[s].lineColor || e) || n !== (k[s].lineDashType ||
                                        l.lineDashType)) && (d.stroke(), d.beginPath(), d.moveTo(v, w), q = k[s].lineColor || e, d.strokeStyle = q, d.setLineDash && (k[s].lineDashType ? (n = k[s].lineDashType, d.setLineDash(I(n, l.lineThickness))) : (n = l.lineDashType, d.setLineDash(p))));
                                if (0 < k[s].markerSize || 0 < l.markerSize)
                                    t = l.getMarkerProperties(s, v, w, d), f = t.color, c.push(t), D = G(D), u && c.push({x: v, y: w, ctx: b, type: t.type, size: t.size, color: D, borderColor: D, borderThickness: t.borderThickness});
                                (k[s].indexLabel || l.indexLabel || k[s].indexLabelFormatter || l.indexLabelFormatter) &&
                                        this._indexLabels.push({chartType: "stepLine", dataPoint: k[s], dataSeries: l, point: {x: v, y: w}, direction: 0 > k[s].y === a.axisY.reversed ? 1 : -1, color: e})
                            }
                    d.stroke();
                    u && b.stroke()
                }
    ...
    A.prototype.renderSpline = function (a) {
        function d(a) {
            ...
            if (0 < a.length) {
                ...
                for (var d = 0; d < a.length - 3; d += 3)
                    if (b.bezierCurveTo(a[d + 1].x, a[d + 1].y, a[d + 2].x, a[d + 2].y, a[d + 3].x, a[d + 3].y), u && c.bezierCurveTo(a[d + 1].x, a[d + 1].y, a[d + 2].x, a[d + 2].y, a[d + 3].x, a[d + 3].y), 0 < d && 0 === d % 3E3 || a[d + 3].newStrokeStyle || a[d + 3].newLineDashArray)
                        b.stroke(), b.beginPath(), b.moveTo(a[d + 3].x, a[d + 3].y), a[d + 3].newStrokeStyle && (b.strokeStyle = a[d + 3].newStrokeStyle), a[d + 3].newLineDashArray &&
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], k = this.data[l];
                b.lineWidth = k.lineThickness;
                var n = k.dataPoints, m = "solid";
                if (b.setLineDash) {
                    var p =
                            I(k.nullDataLineDashType, k.lineThickness), m = k.lineDashType, e = I(m, k.lineThickness);
                    b.setLineDash(e)
                }
                var q = k.id;
                this._eventManager.objectMap[q] = {objectType: "dataSeries", dataSeriesIndex: l};
                q = G(q);
                c.strokeStyle = q;
                c.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0;
                var q = k._colorSet, r = q = k.lineColor = k.options.lineColor ? k.options.lineColor : q[0];
                b.strokeStyle = q;
                var s = 0, v, w, y = [];
                b.beginPath();
                if (0 < n.length)
                    for (w = !1, s = 0; s < n.length; s++)
                        if (v = n[s].getTime ? n[s].x.getTime() : n[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                                v > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))
                            if ("number" !== typeof n[s].y)
                                0 < s && !w && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !n[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (d(y), y = [])), w = !0;
                            else {
                                v = a.axisX.convertValueToPixel(v);
                                w = a.axisY.convertValueToPixel(n[s].y);
                                var t = k.dataPointIds[s];
                                this._eventManager.objectMap[t] = {id: t, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: s, x1: v, y1: w};
                                y[y.length] = {x: v,
                                    y: w};
                                s < n.length - 1 && (r !== (n[s].lineColor || q) || m !== (n[s].lineDashType || k.lineDashType)) && (r = n[s].lineColor || q, y[y.length - 1].newStrokeStyle = r, b.setLineDash && (n[s].lineDashType ? (m = n[s].lineDashType, y[y.length - 1].newLineDashArray = I(m, k.lineThickness)) : (m = k.lineDashType, y[y.length - 1].newLineDashArray = e)));
                                if (0 < n[s].markerSize || 0 < k.markerSize) {
                                    var D = k.getMarkerProperties(s, v, w, b), g = D.color;
                                    f.push(D);
                                    t = G(t);
                                    u && f.push({x: v, y: w, ctx: c, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness})
                                }
                                (n[s].indexLabel ||
                                        k.indexLabel || n[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({chartType: "spline", dataPoint: n[s], dataSeries: k, point: {x: v, y: w}, direction: 0 > n[s].y === a.axisY.reversed ? 1 : -1, color: q});
                                w = !1
                            }
                d(y)
            }
            ...
            b.beginPath();
            u && c.beginPath();
            return{source: b, dest: this.plotArea.ctx, animationCallback: F.xClipAnimation, easingFunction: F.easing.linear, animationBase: 0}
        }
    };
    var N = function (a, d, b, c, f, g, h, l, k, n, m, p, e) {
        "undefined" === typeof e && (e = 1);
        h = h || 0;
        l = l || "black";
        var q = 15 < c - d && 15 < f - b ? 8 : 0.35 * Math.min(c - d, f - b);
        a.beginPath();
        a.moveTo(d, b);
        a.save();
        a.fillStyle = g;
        ...
        a.restore();
        !0 === k && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d + q, b + q), a.lineTo(c - q, b + q), a.lineTo(c, b), a.closePath(), h = a.createLinearGradient((c + d) / 2, b + q, (c + d) / 2, b), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, .4)"),
                a.fillStyle = h, a.fill(), a.restore());
        !0 === n && (a.save(), a.beginPath(), a.moveTo(d, f), a.lineTo(d + q, f - q), a.lineTo(c - q, f - q), a.lineTo(c, f), a.closePath(), h = a.createLinearGradient((c + d) / 2, f - q, (c + d) / 2, f), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = h, a.fill(), a.restore());
        !0 === m && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d + q, b + q), a.lineTo(d + q, f - q), a.lineTo(d, f), a.closePath(), h = a.createLinearGradient(d + q, (f + b) / 2, d, (f + b) / 2), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
                a.fillStyle = h, a.fill(), a.restore());
        !0 === p && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c - q, b + q), a.lineTo(c - q, f - q), a.lineTo(c, f), h = a.createLinearGradient(c - q, (f + b) / 2, c, (f + b) / 2), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = h, h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = h, a.fill(), a.closePath(), a.restore())
    };
    A.prototype.renderColumn = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                    c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth =
                    this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                var n = a.dataSeriesIndexes[c], p = this.data[n], e = p.dataPoints;
                if (0 < e.length)
                    for (var q = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            g = a.axisX.reversed ? g + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + c) * m << 0 : g - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + c) * m << 0;
                            var r = a.axisX.reversed ? g - m << 0 : g + m << 0, s;
                            0 <= e[f].y ? s = k : (s = h, h = k);
                            h > s && (b = h, h = s, s = b);
                            b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                            N(d, g, h, r, s, b, 0, null, q && 0 <= e[f].y, 0 > e[f].y && q, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f,
                                x1: g, y1: h, x2: r, y2: s};
                            b = G(b);
                            u && N(this._eventManager.ghostCtx, g, h, r, s, b, 0, null, !1, !1, !1, !1);
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({chartType: "column", dataPoint: e[f], dataSeries: p, point: {x: g + (r - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? h : s}, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: {x1: g, y1: Math.min(h, s), x2: r, y2: Math.max(h, s)}, color: b})
                        }
            }
            d.restore();
            ...
            return{source: d,
                dest: this.plotArea.ctx, animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a}
        }
    };
    A.prototype.renderStackedColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth :
                    this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, p = a.axisX.dataInfo.minDiff;
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], q = this.data[e], r = q.dataPoints;
                if (0 < r.length) {
                    var s = 5 < p && q.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() :
                                r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                            var c = a.axisX.convertValueToPixel(b), v = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = v + p << 0, y;
                            if (a.axisY.logarithmic)
                                h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : n, f[b] = k);
                            else if (k = a.axisY.convertValueToPixel(r[l].y), 0 <= r[l].y) {
                                var t = f[b] ? f[b] : 0;
                                k -= t;
                                y = n - t;
                                f[b] = t + (y - k)
                            } else
                                t = g[b] ? g[b] : 0, y = k + t, k = n + t, g[b] = t + (y - k);
                            b = r[l].color ? r[l].color : q._colorSet[l % q._colorSet.length];
                            N(d, v, k, w, y, b, 0, null, s && 0 <= r[l].y, 0 > r[l].y && s, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[l];
                            this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: l, x1: v, y1: k, x2: w, y2: y};
                            b = G(b);
                            u && N(this._eventManager.ghostCtx, v, k, w, y, b, 0, null, !1, !1, !1, !1);
                            (r[l].indexLabel || q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedColumn", dataPoint: r[l], dataSeries: q, point: {x: c, y: 0 <= r[l].y ? k : y}, direction: 0 > r[l].y === a.axisY.reversed ? 1 :
                                        -1, bounds: {x1: v, y1: Math.min(k, y), x2: w, y2: Math.max(k, y)}, color: b})
                        }
                }
            }
            d.restore();
            ...
            return{source: d, dest: this.plotArea.ctx, animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a}
        }
    };
    A.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth &&
                    l > m && (l = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < r.length)
                    for (var s = 5 < p && q.bevelEnabled ? !0 : !1, l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                            c = a.axisX.convertValueToPixel(b);
                            k = 0 !== a.dataPointYSums[b] ? 100 * (r[l].y / a.dataPointYSums[b]) : 0;
                            var v = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = v + p << 0, y;
                            if (a.axisY.logarithmic) {
                                h[b] = k + (h[b] ? h[b] : 0);
                                if (0 >= h[b])
                                    continue;
                                ...
                                y = f[b] ? f[b] : n;
                                f[b] = k
                            } else if (k = a.axisY.convertValueToPixel(k), 0 <= r[l].y) {
                                var t = f[b] ? f[b] : 0;
                                k -= t;
                                y = n - t;
                                f[b] = t + (y - k)
                            ...
                            u && N(this._eventManager.ghostCtx, v, k, w, y, b, 0, null, !1, !1, !1, !1);
                            (r[l].indexLabel ||
                                    q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedColumn100", dataPoint: r[l], dataSeries: q, point: {x: c, y: 0 <= r[l].y ? k : y}, direction: 0 > r[l].y === a.axisY.reversed ? 1 : -1, bounds: {x1: v, y1: Math.min(k, y), x2: w, y2: Math.max(k, y)}, color: b})
                        }
            }
            d.restore();
            u && this._eventManager.ghostCtx.restore();
    ...
    A.prototype.renderBar =
            function (a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = null, c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, m = a.axisX.dataInfo.minDiff;
                    isFinite(m) ||
                            (m = 0.3 * Math.abs(a.axisX.range));
                    m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                    this.dataPointMaxWidth && f > n && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
                    !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
                    m < f && (m = f);
                    m > n && (m = n);
                        ...
                        if (0 < e.length) {
                            ...
                            for (f = 0; f < e.length; f++)
                                if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" ===
                                    ...
                                    h = a.axisX.reversed ? h + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + c) * m << 0 : h - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + c) * m << 0;
                                    var r = a.axisX.reversed ? h - m << 0 : h + m << 0, s;
                                    0 <= e[f].y ? s = k : (s = g, g = k);
                                    b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                                    N(d, s, h, g, r, b, 0, null, q, !1, !1, !1, p.fillOpacity);
                                    b = p.dataPointIds[f];
                                    this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: n,
                                        dataPointIndex: f, x1: s, y1: h, x2: g, y2: r};
                                    b = G(b);
                                    u && N(this._eventManager.ghostCtx, s, h, g, r, b, 0, null, !1, !1, !1, !1);
                                    (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({chartType: "bar", dataPoint: e[f], dataSeries: p, point: {x: 0 <= e[f].y ? g : s, y: h + (r - h) / 2}, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: {x1: Math.min(s, g), y1: h, x2: Math.max(s, g), y2: r}, color: b})
                                }
                        }
                    }
                    d.restore();
                    ...
                    return{source: d,
                        dest: this.plotArea.ctx, animationCallback: F.xScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a}
                }
            };
    A.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                    this.dataPointWidth : 0.15 * this.height << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            ...
            this.dataPointMaxWidth && l > m && (l = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && m < l) && (m = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity,
                    l));
            p < l && (p = l);
            p > m && (p = m);
            d.save();
                ...
                if (0 < r.length) {
                    ...
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() :
                            ...
                            var c = a.axisX.convertValueToPixel(b), v = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = v + p << 0, y;
                            if (a.axisY.logarithmic)
                                h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : n, f[b] = k = a.axisY.convertValueToPixel(h[b]));
                            else if (k = a.axisY.convertValueToPixel(r[l].y), 0 <= r[l].y) {
                                var t = f[b] ? f[b] : 0;
                                y = n + t;
                                k += t;
                                ...
                                t = g[b] ? g[b] : 0, y = k - t, k = n - t, g[b] = t + (k - y);
                            b = r[l].color ? r[l].color : q._colorSet[l % q._colorSet.length];
                            N(d, y, v, k, w, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[l];
                            this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: l, x1: y, y1: v, x2: k, y2: w};
                            b = G(b);
                            u && N(this._eventManager.ghostCtx, y, v, k, w, b, 0, null, !1, !1, !1, !1);
                            (r[l].indexLabel || q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedBar", dataPoint: r[l], dataSeries: q, point: {x: 0 <= r[l].y ? k : y, y: c}, direction: 0 > r[l].y === a.axisY.reversed ? 1 : -1, bounds: {x1: Math.min(y,
                                            k), y1: v, x2: Math.max(y, k), y2: w}, color: b})
                        }
                }
            }
            d.restore();
            ...
            return{source: d, dest: this.plotArea.ctx, animationCallback: F.xScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: a}
        }
    };
    A.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                    0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && l > m && (l = Math.min(this.dataPointWidth ?
            ...
            u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip());
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], q = this.data[e],
                        r = q.dataPoints;
                if (0 < r.length) {
                    var s = 5 < p && q.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < r.length; l++)
                        if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                            var c = a.axisX.convertValueToPixel(b), v;
                            v = 0 !== a.dataPointYSums[b] ? 100 * (r[l].y / a.dataPointYSums[b]) : 0;
                            var w = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, y = w + p << 0;
                            if (a.axisY.logarithmic) {
                                h[b] = v + (h[b] ? h[b] : 0);
                                if (0 >= h[b])
                                    continue;
                                ...
                                f[b] = k = a.axisY.convertValueToPixel(h[b])
                                    ...
                                    a.axisY.convertValueToPixel(v), 0 <= r[l].y) {
                                var t = f[b] ? f[b] : 0;
                                v = n + t;
                                k += t;
                                f[b] = t + (k - v)
                            } else
                                t = g[b] ? g[b] : 0, v = k - t, k = n - t, g[b] = t + (k - v);
                            b = r[l].color ? r[l].color : q._colorSet[l % q._colorSet.length];
                            N(d, v, w, k, y, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[l];
                            this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: l, x1: v, y1: w, x2: k, y2: y};
                            b = G(b);
                            u && N(this._eventManager.ghostCtx, v, w, k, y, b, 0, null, !1, !1, !1, !1);
                            (r[l].indexLabel || q.indexLabel || r[l].indexLabelFormatter || q.indexLabelFormatter) &&
                                    this._indexLabels.push({chartType: "stackedBar100", dataPoint: r[l], dataSeries: q, point: {x: 0 <= r[l].y ? k : v, y: c}, direction: 0 > r[l].y === a.axisY.reversed ? 1 : -1, bounds: {x1: Math.min(v, k), y1: w, x2: Math.max(v, k), y2: y}, color: b})
                        }
                }
            }
            d.restore();
    ...
    A.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, h = m.id;
                this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: n};
                h = G(h);
                c.fillStyle = h;
                var h = [], e = !0, q = 0, r, s, v, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        y, t = null;
                if (0 < p.length) {
                    var D = m._colorSet[q % m._colorSet.length], x = m.lineColor = m.options.lineColor || D, aa = x;
                    b.fillStyle = D;
                    b.strokeStyle = x;
                    b.lineWidth = m.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = I(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, R = I(z, m.lineThickness);
                        b.setLineDash(R)
                    }
                    for (var J = !0; q < p.length; q++)
                        if (v = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !J)))
                            if ("number" !== typeof p[q].y)
                                ...
                                e || J ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, s), u && c.lineTo(r, s)) : (b.beginPath(), b.moveTo(r, s), u && (c.beginPath(), c.moveTo(r, s)), t = {x: r, y: s}), J = e = !1) : (b.lineTo(r, s), u && c.lineTo(r, s), 0 == q % 250 && d());
                                q < p.length - 1 && (aa !== (p[q].lineColor || x) || z !== (p[q].lineDashType ||
                                        m.lineDashType)) && (d(), aa = p[q].lineColor || x, b.strokeStyle = aa, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, b.setLineDash(I(z, m.lineThickness))) : (z = m.lineDashType, b.setLineDash(R))));
                                var H = m.dataPointIds[q];
                                this._eventManager.objectMap[H] = {id: H, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: q, x1: r, y1: s};
                                0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize) && (v = m.getMarkerProperties(q, r, s, b), l = v.color, h.push(v), H = G(H), u && h.push({x: r, y: s, ctx: c, type: v.type, size: v.size, color: H, borderColor: H,
                                    borderThickness: v.borderThickness}));
                                (p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "area", dataPoint: p[q], dataSeries: m, point: {x: r, y: s}, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: D})
                            }
                    d();
                    O.drawMarkers(h);
                    m.markerColor = l
    ...
    A.prototype.renderSplineArea =
            function (a) {
                    ...
                    if (0 < d.length) {
                        if (0 < m.lineThickness) {
                            ...
                            for (var e = 0; e < d.length - 3; e += 3)
                                if (b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), u && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray)
                                    b.stroke(), b.beginPath(), b.moveTo(d[e + 3].x, d[e +
                        ...
                        for (e = 0; e < d.length - 3; e += 3)
                            b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), u && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y);
                ...
                var b = a.targetCanvasCtx || this.plotArea.ctx;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var c = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, h = [], l = null, k = this.plotArea;
                    b.save();
                    u && c.save();
                    b.beginPath();
                    ...
                    for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                        ...
                        h = G(h);
                        c.fillStyle = h;
                        var h = [], e = 0, q, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v, w = null, y = [];
                        if (0 < p.length) {
                            var t = m._colorSet[e % m._colorSet.length], D = m.lineColor = m.options.lineColor || t, x = D;
                            b.fillStyle =
                                    t;
                            b.strokeStyle = D;
                            b.lineWidth = m.lineThickness;
                            var z = "solid";
                            if (b.setLineDash) {
                                var A = I(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, B = I(z, m.lineThickness);
                                b.setLineDash(B)
                            }
                            for (r = !1; e < p.length; e++)
                                if (q = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                    if ("number" !== typeof p[e].y)
                                        0 < e && !r && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                                A, z = m.nullDataLineDashType) : (d(), y = [])), r = !0;
                                    else {
                                        q = a.axisX.convertValueToPixel(q);
                                        r = a.axisY.convertValueToPixel(p[e].y);
                                        var R = m.dataPointIds[e];
                                        this._eventManager.objectMap[R] = {id: R, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: q, y1: r};
                                        y[y.length] = {x: q, y: r};
                                        e < p.length - 1 && (x !== (p[e].lineColor || D) || z !== (p[e].lineDashType || m.lineDashType)) && (x = p[e].lineColor || D, y[y.length - 1].newStrokeStyle = x, b.setLineDash && (p[e].lineDashType ? (z = p[e].lineDashType, y[y.length - 1].newLineDashArray = I(z, m.lineThickness)) :
                                                (z = m.lineDashType, y[y.length - 1].newLineDashArray = B)));
                                        if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize)) {
                                            var J = m.getMarkerProperties(e, q, r, b), l = J.color;
                                            h.push(J);
                                            R = G(R);
                                            u && h.push({x: q, y: r, ctx: c, type: J.type, size: J.size, color: R, borderColor: R, borderThickness: J.borderThickness})
                                        }
                                        (p[e].indexLabel || m.indexLabel || p[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "splineArea", dataPoint: p[e], dataSeries: m, point: {x: q, y: r}, direction: 0 > p[e].y === a.axisY.reversed ? 1 : -1,
                                            color: t});
                                        r = !1
                                    }
                            d();
    ...
    A.prototype.renderStepArea = function (a) {
        function d() {
            t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(r, y), b.lineTo(t.x, y), b.closePath(),
                    b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, u && (c.lineTo(r, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(r, s), c.beginPath(), c.moveTo(r, s), t = {x: r, y: s})
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, h = [], l = null, k = this.plotArea;
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                h = G(h);
                c.fillStyle = h;
                var h = [], e = !0, q = 0, r, s, v, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null, D = !1;
                if (0 < p.length) {
                    var x = m._colorSet[q % m._colorSet.length], z = m.lineColor = m.options.lineColor || x, A = z;
                    b.fillStyle = x;
                    b.strokeStyle = z;
                    b.lineWidth = m.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var R =
                                I(m.nullDataLineDashType, m.lineThickness), B = m.lineDashType, J = I(B, m.lineThickness);
                        b.setLineDash(J)
                    }
                    for (; q < p.length; q++)
                        if (v = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !D))) {
                            var H = s;
                            "number" !== typeof p[q].y ? (m.connectNullData || (D || e) || d(), D = !0) : (r = a.axisX.convertValueToPixel(v), s = a.axisY.convertValueToPixel(p[q].y), e || D ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || B === m.lineDashType && m.lineDashType !==
                                ...
                                dataPoint: p[q], dataSeries: m, point: {x: r, y: s}, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x}))
                        }
                    d();
                    O.drawMarkers(h);
                    m.markerColor = l
    ...
    A.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = [], g = null, h = this.plotArea, l = [], k = [], n = [], m = [], p = 0, e, q, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
            u && v.beginPath();
            b.save();
            u && v.save();
            b.beginPath();
            ...
            for (var w = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var y = a.dataSeriesIndexes[h], t = this.data[y], D = t.dataPoints;
                t.dataPointIndexes = [];
                for (p = 0; p < D.length; p++)
                    y = D[p].x.getTime ? D[p].x.getTime() : D[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0);
                n.sort(ya)
            }
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                k = [];
                p = t.id;
                this._eventManager.objectMap[p] = {objectType: "dataSeries", dataSeriesIndex: y};
                p = G(p);
                v.fillStyle = p;
                if (0 < n.length) {
                    var c = t._colorSet[0],
                            x = t.lineColor = t.options.lineColor || c, z = x;
                    b.fillStyle = c;
                    b.strokeStyle = x;
                    b.lineWidth = t.lineThickness;
                    var A = "solid";
                    if (b.setLineDash) {
                        var B = I(t.nullDataLineDashType, t.lineThickness), A = t.lineDashType, R = I(A, t.lineThickness);
                        b.setLineDash(R)
                    }
                    for (var J = !0, p = 0; p < n.length; p++) {
                        r = n[p];
                        var H = null, H = 0 <= t.dataPointIndexes[r] ? D[t.dataPointIndexes[r]] : {x: r, y: null};
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y)
                                t.connectNullData || (J || w) || d(),
                                        J = !0;
                            else {
                                e = a.axisX.convertValueToPixel(r);
                                var ea = l[r] ? l[r] : 0;
                                if (a.axisY.logarithmic) {
                                    m[r] = H.y + (m[r] ? m[r] : 0);
                                    if (0 >= m[r])
                                        continue;
                                    q = a.axisY.convertValueToPixel(m[r])
                                } else
                                    q = a.axisY.convertValueToPixel(H.y), q -= ea;
                                k.push({x: e, y: s - ea});
                                l[r] = s - q;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, q), u && v.lineTo(e, q)) : (b.beginPath(), b.moveTo(e, q), u && (v.beginPath(),
                                        v.moveTo(e, q))), J = w = !1) : (b.lineTo(e, q), u && v.lineTo(e, q), 0 == p % 250 && (d(), b.moveTo(e, q), u && v.moveTo(e, q), k.push({x: e, y: s - ea})));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, q), k.push({x: e, y: s - ea}), z = D[p].lineColor || x, b.strokeStyle = z, b.setLineDash && (D[p].lineDashType ? (A = D[p].lineDashType, b.setLineDash(I(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(R))));
                                if (0 <= t.dataPointIndexes[r]) {
                                    var fa = t.dataPointIds[t.dataPointIndexes[r]];
                                    this._eventManager.objectMap[fa] = {id: fa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[r], x1: e, y1: q}
                                }
                                0 <= t.dataPointIndexes[r] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (r = t.getMarkerProperties(p, e, q, b), g = r.color, f.push(r), markerColor = G(fa), u && f.push({x: e, y: q, ctx: v, type: r.type, size: r.size, color: markerColor, borderColor: markerColor, borderThickness: r.borderThickness}));
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedArea",
                                    dataPoint: H, dataSeries: t, point: {x: e, y: q}, direction: 0 > D[p].y === a.axisY.reversed ? 1 : -1, color: c})
                            }
                    }
                    d();
                    b.moveTo(e, q);
    ...
    A.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = this.plotArea, g = [], h = null, l = [], k = [], n = [], m = [], p = 0, e, q, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v = this._eventManager.ghostCtx;
            b.save();
            u && v.save();
            b.beginPath();
            b.rect(f.x1, f.y1, f.width, f.height);
            b.clip();
            u && (v.beginPath(), v.rect(f.x1, f.y1, f.width, f.height),
                    v.clip());
            for (var w = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var y = a.dataSeriesIndexes[f], t = this.data[y], x = t.dataPoints;
                t.dataPointIndexes = [];
                for (p = 0; p < x.length; p++)
                    y = x[p].x.getTime ? x[p].x.getTime() : x[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0);
                n.sort(ya)
            }
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                w = !0;
                c = t.id;
                this._eventManager.objectMap[c] = {objectType: "dataSeries", dataSeriesIndex: y};
                c = G(c);
                v.fillStyle = c;
                k = [];
                if (0 < n.length) {
                    var c = t._colorSet[p %
                            t._colorSet.length], z = t.lineColor = t.options.lineColor || c, A = z;
                    b.fillStyle = c;
                    b.strokeStyle = z;
                    b.lineWidth = t.lineThickness;
                    var B = "solid";
                    if (b.setLineDash) {
                        var E = I(t.nullDataLineDashType, t.lineThickness), B = t.lineDashType, R = I(B, t.lineThickness);
                        b.setLineDash(R)
                    }
                    for (var J = !0, p = 0; p < n.length; p++) {
                        r = n[p];
                        var H = null, H = 0 <= t.dataPointIndexes[r] ? x[t.dataPointIndexes[r]] : {x: r, y: null};
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y)
                                t.connectNullData ||
                                        (J || w) || d(), J = !0;
                                ...
                                var ea;
                                ea = 0 !== a.dataPointYSums[r] ? 100 * (H.y / a.dataPointYSums[r]) : 0;
                                e = a.axisX.convertValueToPixel(r);
                                var fa = l[r] ? l[r] : 0;
                                if (a.axisY.logarithmic) {
                                    m[r] = ea + (m[r] ? m[r] : 0);
                                    ...
                                    q = a.axisY.convertValueToPixel(ea), q -= fa;
                                k.push({x: e, y: s - fa});
                                l[r] = s - q;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(E)),
                                        b.lineTo(e, q), u && v.lineTo(e, q)) : (b.beginPath(), b.moveTo(e, q), u && (v.beginPath(), v.moveTo(e, q))), J = w = !1) : (b.lineTo(e, q), u && v.lineTo(e, q), 0 == p % 250 && (d(), b.moveTo(e, q), u && v.moveTo(e, q), k.push({x: e, y: s - fa})));
                                p < x.length - 1 && (A !== (x[p].lineColor || z) || B !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, q), k.push({x: e, y: s - fa}), A = x[p].lineColor || z, b.strokeStyle = A, b.setLineDash && (x[p].lineDashType ? (B = x[p].lineDashType, b.setLineDash(I(B, t.lineThickness))) : (B = t.lineDashType, b.setLineDash(R))));
                                if (0 <= t.dataPointIndexes[r]) {
                                    var Fa = t.dataPointIds[t.dataPointIndexes[r]];
                                    this._eventManager.objectMap[Fa] = {id: Fa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[r], x1: e, y1: q}
                                }
                                0 <= t.dataPointIndexes[r] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (r = t.getMarkerProperties(p, e, q, b), h = r.color, g.push(r), markerColor = G(Fa), u && g.push({x: e, y: q, ctx: v, type: r.type, size: r.size, color: markerColor, borderColor: markerColor, borderThickness: r.borderThickness}));
                                (H.indexLabel || t.indexLabel ||
                                        H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedArea100", dataPoint: H, dataSeries: t, point: {x: e, y: q}, direction: 0 > x[p].y === a.axisY.reversed ? 1 : -1, color: c})
                            }
                    }
                    d();
                    b.moveTo(e, q);
    ...
    A.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, l = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                for (var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, e = 0, c = 0; c < p.length; c++)
                    f = p[c].getTime ? f = p[c].x.getTime() : f =
                            p[c].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[c].z || (e = p[c].z, e > h && (h = e), e < l && (l = e));
            for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), k = 0; k < a.dataSeriesIndexes.length; k++)
                if (n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, 0 < p.length)
                    for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)
                        if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[c].y) {
                            f =
                                    a.axisX.convertValueToPixel(f);
                            g = a.axisY.convertValueToPixel(p[c].y);
                            var e = p[c].z, r = 2 * Math.max(Math.sqrt((h === l ? b / 2 : q + (b - q) / (h - l) * (e - l)) / Math.PI) << 0, 1), e = m.getMarkerProperties(c, d);
                            e.size = r;
                            d.globalAlpha = m.fillOpacity;
                            O.drawMarker(f, g, d, e.type, e.size, e.color, e.borderColor, e.borderThickness);
                            d.globalAlpha = 1;
                            var s = m.dataPointIds[c];
                            this._eventManager.objectMap[s] = {id: s, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: c, x1: f, y1: g, size: r};
                            r = G(s);
                            u && O.drawMarker(f, g, this._eventManager.ghostCtx,
                                    e.type, e.size, r, r, e.borderThickness);
                            (p[c].indexLabel || m.indexLabel || p[c].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "bubble", dataPoint: p[c], dataSeries: m, point: {x: f, y: g}, direction: 1, bounds: {x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2}, color: null})
                        }
            d.restore();
            u && this._eventManager.ghostCtx.restore();
            return{source: d, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad, animationBase: 0}
        }
    };
    A.prototype.renderScatter =
            function (a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = this.plotArea, c = 0, f, g;
                    ...
                    for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                        var l = a.dataSeriesIndexes[h], k = this.data[l], n = k.dataPoints;
                        if (0 < n.length) {
                            d.strokeStyle = "#4572A7 ";
                            Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
                            for (var m = 0, p = 0, c = 0; c < n.length; c++)
                                if (f = n[c].getTime ? f = n[c].x.getTime() : f = n[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[c].y) {
                                    ...
                                    d.globalAlpha = 1;
                                    Math.sqrt((m - f) * (m - f) + (p - g) * (p - g)) < Math.min(e.size,
                                            ...
                                            2, x2: f + e.size / 2, y2: g + e.size / 2}, color: null}), m = f, p = g)
                                }
                        }
                    }
                    d.restore();
    ...
    A.prototype.renderCandlestick = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx, b = this._eventManager.ghostCtx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)
                    for (var v = 5 < p && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length &&
                                "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            var w = g - p / 2 << 0, y = w + p << 0, c = s[f].color ? s[f].color : r._colorSet[0], t = Math.round(Math.max(1, 0.15 * p)), x = 0 === t % 2 ? 0 : 0.5, z = r.dataPointIds[f];
                            this._eventManager.objectMap[z] = {id: z, objectType: "dataPoint",
                                dataSeriesIndex: q, dataPointIndex: f, x1: w, y1: h, x2: y, y2: l, x3: g, y3: k, x4: g, y4: n, borderThickness: t, color: c};
                            d.strokeStyle = c;
                            d.beginPath();
                            d.lineWidth = t;
                            b.lineWidth = Math.max(t, 4);
                            "candlestick" === r.type ? (d.moveTo(g - x, l), d.lineTo(g - x, Math.min(h, n)), d.stroke(), d.moveTo(g - x, Math.max(h, n)), d.lineTo(g - x, k), d.stroke(), N(d, w, Math.min(h, n), y, Math.max(h, n), s[f].y[0] <= s[f].y[3] ? r.risingColor : c, t, c, v, v, !1, !1, r.fillOpacity), u && (c = G(z), b.strokeStyle = c, b.moveTo(g - x, l), b.lineTo(g - x, Math.min(h, n)), b.stroke(), b.moveTo(g -
                            ...
                            (s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter ||
                                    r.indexLabelFormatter) && this._indexLabels.push({chartType: r.type, dataPoint: s[f], dataSeries: r, point: {x: w + (y - w) / 2, y: a.axisY.reversed ? k : l}, direction: 1, bounds: {x1: w, y1: Math.min(l, k), x2: y, y2: Math.max(l, k)}, color: c})
                        }
            }
            d.restore();
            u && b.restore();
    ...
    A.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                    c = this.plotArea, f = 0, g, h, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            this.dataPointMaxWidth && f > g &&
                    (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, g));
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n =
                        a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints;
                if (0 < p.length)
                    for (var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            ...
                            var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount +
                                    k) * l << 0 : b - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + k) * l << 0, r = a.axisX.reversed ? q - l << 0 : q + l << 0, b = p[f].color ? p[f].color : m._colorSet[f % m._colorSet.length];
                            if (c > g) {
                                var s = c, c = g;
                                g = s
                            }
                            s = m.dataPointIds[f];
                            this._eventManager.objectMap[s] = {id: s, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: q, y1: c, x2: r, y2: g};
                            N(d, q, c, r, g, b, 0, b, e, e, !1, !1, m.fillOpacity);
                            b = G(s);
                            u && N(this._eventManager.ghostCtx, q, c, r, g, b, 0, null, !1, !1, !1, !1);
                            if (p[f].indexLabel || m.indexLabel || p[f].indexLabelFormatter ||
                                    m.indexLabelFormatter)
                                this._indexLabels.push({chartType: "rangeColumn", dataPoint: p[f], dataSeries: m, indexKeyword: 0, point: {x: q + (r - q) / 2, y: p[f].y[1] >= p[f].y[0] ? g : c}, direction: p[f].y[1] >= p[f].y[0] ? -1 : 1, bounds: {x1: q, y1: Math.min(c, g), x2: r, y2: Math.max(c, g)}, color: b}), this._indexLabels.push({chartType: "rangeColumn", dataPoint: p[f], dataSeries: m, indexKeyword: 1, point: {x: q + (r - q) / 2, y: p[f].y[1] >= p[f].y[0] ? c : g}, direction: p[f].y[1] >= p[f].y[0] ? 1 : -1, bounds: {x1: q, y1: Math.min(c, g), x2: r, y2: Math.max(c, g)}, color: b})
                        }
            }
            d.restore();
            u && this._eventManager.ghostCtx.restore();
    ...
    A.prototype.renderRangeBar = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h, l, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = a.dataSeriesIndexes[n], p = this.data[m], e = p.dataPoints;
                if (0 < e.length) {
                    var q = 5 < k && p.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ?
                            ...
                            var r = a.axisX.reversed ? h - k << 0 : h + k << 0;
                            c > g && (b = c, c =
                                    g, g = b);
                            b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                            N(d, c, h, g, r, b, 0, null, q, !1, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: c, y1: h, x2: g, y2: r};
                            b = G(b);
                            u && N(this._eventManager.ghostCtx, c, h, g, r, b, 0, null, !1, !1, !1, !1);
                            if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter)
                                this._indexLabels.push({chartType: "rangeBar", dataPoint: e[f], dataSeries: p, indexKeyword: 0, point: {x: e[f].y[1] >=
                                                e[f].y[0] ? c : g, y: h + (r - h) / 2}, direction: e[f].y[1] >= e[f].y[0] ? -1 : 1, bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: r}, color: b}), this._indexLabels.push({chartType: "rangeBar", dataPoint: e[f], dataSeries: p, indexKeyword: 1, point: {x: e[f].y[1] >= e[f].y[0] ? g : c, y: h + (r - h) / 2}, direction: e[f].y[1] >= e[f].y[0] ? 1 : -1, bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: r}, color: b})
                        }
                }
            }
            d.restore();
            u && this._eventManager.ghostCtx.restore();
            return{source: d, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad,
                animationBase: 0}
        }
    };
    A.prototype.renderRangeArea = function (a) {
        function d() {
            if (w) {
                ...
                for (var d = l.length - 1; 0 <= d; d--)
                    a = l[d], b.lineTo(a.x, a.y), c.lineTo(a.x, a.y);
                b.closePath();
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx, f = [], g = null, h = this.plotArea;
            b.save();
            u && c.save();
            b.beginPath();
            b.rect(h.x1, h.y1, h.width, h.height);
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = [], k = a.dataSeriesIndexes[h], n = this.data[k], m = n.dataPoints, f = n.id;
                this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                f = G(f);
                c.fillStyle = f;
                var f = [], p = !0, e = 0, q, r, s, v, w = null;
                if (0 < m.length) {
                    var y =
                            n._colorSet[e % n._colorSet.length], t = n.lineColor = n.options.lineColor || y, x = t;
                    b.fillStyle = y;
                    b.strokeStyle = t;
                    b.lineWidth = n.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = I(n.nullDataLineDashType, n.lineThickness), z = n.lineDashType, B = I(z, n.lineThickness);
                        b.setLineDash(B)
                    }
                    for (var E = !0; e < m.length; e++)
                        if (v = m[e].x.getTime ? m[e].x.getTime() : m[e].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !E)))
                            if (null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" ===
                                    typeof m[e].y[1]) {
                                q = a.axisX.convertValueToPixel(v);
                                r = a.axisY.convertValueToPixel(m[e].y[0]);
                                s = a.axisY.convertValueToPixel(m[e].y[1]);
                                p || E ? (n.connectNullData && !p ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = B, z = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, r), u && c.lineTo(q, r), l.push({x: q, y: s})) : (b.beginPath(), b.moveTo(q, r), w = {x: q, y: r}, l = [], l.push({x: q, y: s}), u && (c.beginPath(), c.moveTo(q, r))), E = p =
                                        !1) : (b.lineTo(q, r), l.push({x: q, y: s}), u && c.lineTo(q, r), 0 == e % 250 && d());
                                v = n.dataPointIds[e];
                                this._eventManager.objectMap[v] = {id: v, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: q, y1: r, y2: s};
                                e < m.length - 1 && (x !== (m[e].lineColor || t) || z !== (m[e].lineDashType || n.lineDashType)) && (d(), x = m[e].lineColor || t, l[l.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (m[e].lineDashType ? (z = m[e].lineDashType, l[l.length - 1].newLineDashArray = I(z, n.lineThickness), b.setLineDash(l[l.length - 1].newLineDashArray)) :
                                        (z = n.lineDashType, l[l.length - 1].newLineDashArray = B, b.setLineDash(B))));
                                if (0 !== m[e].markerSize && (0 < m[e].markerSize || 0 < n.markerSize)) {
                                    var R = n.getMarkerProperties(e, q, s, b);
                                    f.push(R);
                                    var J = G(v);
                                    u && f.push({x: q, y: s, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness});
                                    R = n.getMarkerProperties(e, q, r, b);
                                    g = R.color;
                                    f.push(R);
                                    J = G(v);
                                    u && f.push({x: q, y: r, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness})
                                }
                                if (m[e].indexLabel || n.indexLabel || m[e].indexLabelFormatter ||
                                        n.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "rangeArea", dataPoint: m[e], dataSeries: n, indexKeyword: 0, point: {x: q, y: r}, direction: m[e].y[0] > m[e].y[1] === a.axisY.reversed ? -1 : 1, color: y}), this._indexLabels.push({chartType: "rangeArea", dataPoint: m[e], dataSeries: n, indexKeyword: 1, point: {x: q, y: s}, direction: m[e].y[0] > m[e].y[1] === a.axisY.reversed ? 1 : -1, color: y})
                            } else
                                E || p || d(), E = !0;
                    d();
                    O.drawMarkers(f);
            ...
            b.restore();
            u && this._eventManager.ghostCtx.restore();
            return{source: b, dest: this.plotArea.ctx,
                animationCallback: F.xClipAnimation, easingFunction: F.easing.linear, animationBase: 0}
        }
    };
        ...
        function d(a, d) {
            ...
            if (0 < e.length) {
                if (0 < k.lineThickness) {
                    ...
                    for (var f = 0; f < e.length - 3; f += 3) {
                        if (e[f].newStrokeStyle || e[f].newLineDashArray)
                            b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), e[f].newStrokeStyle && (b.strokeStyle = e[f].newStrokeStyle), e[f].newLineDashArray && b.setLineDash(e[f].newLineDashArray);
                ...
                for (f = 0; f < e.length - 3; f += 3)
                    b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y), u && c.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = ua(s, 2);
                b.lineTo(s[s.length - 1].x, s[s.length - 1].y);
                for (f = e.length - 1; 2 < f; f -= 3)
                    b.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y), u && c.bezierCurveTo(e[f -
                ...
                if (0 < k.lineThickness) {
                    ...
                    for (var g = f = 0; f < e.length - 3; f += 3, g++) {
                        if (r[g].newStrokeStyle || r[g].newLineDashArray)
                            b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), r[g].newStrokeStyle && (b.strokeStyle = r[g].newStrokeStyle), r[g].newLineDashArray && b.setLineDash(r[g].newLineDashArray);
                        b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y)
                    }
                    b.stroke()
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                this._eventManager.objectMap[f] =
                        {objectType: "dataSeries", dataSeriesIndex: l};
                f = G(f);
                c.fillStyle = f;
                var f = [], m = 0, p, e, q, r = [], s = [];
                if (0 < n.length) {
                    var v = k._colorSet[m % k._colorSet.length], w = k.lineColor = k.options.lineColor || v, y = w;
                    b.fillStyle = v;
                    b.lineWidth = k.lineThickness;
                    var t = "solid", x;
                    if (b.setLineDash) {
                        var z = I(k.nullDataLineDashType, k.lineThickness), t = k.lineDashType;
                        x = I(t, k.lineThickness)
                    }
                    for (e = !1; m < n.length; m++)
                        if (p = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                !e)))
                            if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                                ...
                                q = a.axisY.convertValueToPixel(n[m].y[1]);
                                var A = k.dataPointIds[m];
                                this._eventManager.objectMap[A] = {id: A, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: m, x1: p, y1: e, y2: q};
                                r[r.length] = {x: p, y: e};
                                s[s.length] = {x: p, y: q};
                                m < n.length - 1 && (y !== (n[m].lineColor || w) || t !== (n[m].lineDashType || k.lineDashType)) && (y = n[m].lineColor || w, r[r.length -
                                1].newStrokeStyle = y, b.setLineDash && (n[m].lineDashType ? (t = n[m].lineDashType, r[r.length - 1].newLineDashArray = I(t, k.lineThickness)) : (t = k.lineDashType, r[r.length - 1].newLineDashArray = x)));
                                if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < k.markerSize)) {
                                    var B = k.getMarkerProperties(m, p, e, b), g = B.color;
                                    f.push(B);
                                    var E = G(A);
                                    u && f.push({x: p, y: e, ctx: c, type: B.type, size: B.size, color: E, borderColor: E, borderThickness: B.borderThickness});
                                    B = k.getMarkerProperties(m, p, q, b);
                                    f.push(B);
                                    E = G(A);
                                    u && f.push({x: p, y: q, ctx: c, type: B.type,
                                        size: B.size, color: E, borderColor: E, borderThickness: B.borderThickness})
                                }
                                if (n[m].indexLabel || k.indexLabel || n[m].indexLabelFormatter || k.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "splineArea", dataPoint: n[m], dataSeries: k, indexKeyword: 0, point: {x: p, y: e}, direction: n[m].y[0] <= n[m].y[1] ? -1 : 1, color: v}), this._indexLabels.push({chartType: "splineArea", dataPoint: n[m], dataSeries: k, indexKeyword: 1, point: {x: p, y: q}, direction: n[m].y[0] <= n[m].y[1] ? 1 : -1, color: v});
                                e = !1
                            } else
                                0 < m && !e && (k.connectNullData ? b.setLineDash &&
                                        (0 < r.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = z, t = k.nullDataLineDashType) : (d(x, w), r = [], s = [])), e = !0;
                    d(x, w);
                    O.drawMarkers(f);
                    k.markerColor = g
                }
    ...
    A.prototype.renderPie = function (a) {
        function d() {
            if (n && m) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
                    var g =
                            m[f], h = n.dataPointIds[f], l = {id: h, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0};
                    q.push(l);
                    var p = {percent: null, total: null}, r = null, p = k.getPercentAndTotal(n, g);
                    if (n.indexLabelFormatter || g.indexLabelFormatter)
                        r = {chart: k.options, dataSeries: n, dataPoint: g, total: p.total, percent: p.percent};
                    p = g.indexLabelFormatter ? g.indexLabelFormatter(r) : g.indexLabel ? k.replaceKeywordsWithValue(g.indexLabel, g, n, f) : n.indexLabelFormatter ? n.indexLabelFormatter(r) : n.indexLabel ? k.replaceKeywordsWithValue(n.indexLabel,
                            g, n, f) : g.label ? g.label : "";
                    k._eventManager.objectMap[h] = l;
                    l.center = {x: t.x, y: t.y};
                    l.y = g.y;
                    l.radius = B;
                    l.percentInnerRadius = F;
                    l.indexLabelText = p;
                    l.indexLabelPlacement = n.indexLabelPlacement;
                    l.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor : n.options.indexLabelLineColor ? n.options.indexLabelLineColor : g.color ? g.color : n._colorSet[f % n._colorSet.length];
                    ...
                    l.indexLabelFontStyle = g.indexLabelFontStyle ? g.indexLabelFontStyle : n.indexLabelFontStyle;
                    ...
                    l.indexLabelBackgroundColor =
                            g.indexLabelBackgroundColor ? g.indexLabelBackgroundColor : n.options.indexLabelBackgroundColor ? n.options.indexLabelBackgroundColor : n.indexLabelBackgroundColor;
                    l.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : n.indexLabelMaxWidth ? n.indexLabelMaxWidth : 0.33 * e.width;
                    l.indexLabelWrap = "undefined" !== typeof g.indexLabelWrap ? g.indexLabelWrap : n.indexLabelWrap;
                    l.startAngle = 0 === f ? n.startAngle ? n.startAngle / 180 * Math.PI : 0 : q[f - 1].endAngle;
                    ...
                    if (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) {
                        if (0 === a || q[c].midAngle > l.midAngle)
                            c = f;
                        a++
                    } else if (l.midAngle > 3 * Math.PI / 2 - w && l.midAngle < 3 * Math.PI / 2 + w) {
                        if (0 === b || q[d].midAngle > l.midAngle)
                            d = f;
                        b++
                    }
                    l.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
                    l.indexLabelTextBlock = new W(k.plotArea.ctx, {fontSize: l.indexLabelFontSize, fontFamily: l.indexLabelFontFamily, fontColor: l.indexLabelFontColor, fontStyle: l.indexLabelFontStyle,
                        fontWeight: l.indexLabelFontWeight, horizontalAlign: "left", backgroundColor: l.indexLabelBackgroundColor, maxWidth: l.indexLabelMaxWidth, maxHeight: l.indexLabelWrap ? 5 * l.indexLabelFontSize : 1.5 * l.indexLabelFontSize, text: l.indexLabelText, padding: 0, textBaseline: "top"});
                    l.indexLabelTextBlock.measureText()
                }
                h = g = 0;
                p = !1;
                for (f = 0; f < m.length; f++)
                    l = q[(c + f) % m.length], 1 < a && (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) && (g <= a / 2 && !p ? (l.hemisphere = "right", g++) : (l.hemisphere = "left", p = !0));
                p = !1;
                for (f = 0; f < m.length; f++)
                    l =
                            q[(d + f) % m.length], 1 < b && (l.midAngle > 3 * Math.PI / 2 - w && l.midAngle < 3 * Math.PI / 2 + w) && (h <= b / 2 && !p ? (l.hemisphere = "left", h++) : (l.hemisphere = "right", p = !0))
            }
        }
        function b(a) {
            ...
            for (b = 0; b < m.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * B * Math.cos(q[b].midAngle), g = 0.07 * B * Math.sin(q[b].midAngle), l = !1;
                    if (m[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (t.x + f)) || 1E-9 < Math.abs(q[b].center.y -
                                (t.y + g)))
                            q[b].center.x = t.x + f * a, q[b].center.y = t.y + g * a, l = !0
                    } else if (0 < Math.abs(q[b].center.x - t.x) || 0 < Math.abs(q[b].center.y - t.y))
                        q[b].center.x = t.x + f * (1 - a), q[b].center.y = t.y + g * (1 - a), l = !0;
                    l && (f = {}, f.dataSeries = n, f.dataPoint = n.dataPoints[b], f.index = b, k.toolTip.highlightObjects([f]));
                    Ga(k.plotArea.ctx, q[b].center, q[b].radius, m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length], n.type, c, d, n.fillOpacity, q[b].percentInnerRadius)
                }
            }
            a = k.plotArea.ctx;
            a.save();
        ...
        function c(a, b) {
            var c = 0, c = a.indexLabelTextBlock.y -
                    a.indexLabelTextBlock.height / 2, d = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, e = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
            return c = b.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? e - d : c - f
        }
        function f(a) {
            for (var b = null, d = 1; d < m.length; d++)
                if (b = (a + d + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                    b = null;
                    break
                } else if (q[b].indexLabelText && b !== a && (0 > c(q[b], q[a]) || ("right" === q[a].hemisphere ? q[b].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y :
                        q[b].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y)))
                    break;
                else
                    b = null;
            return b
        ...
        function g(a, b, d) {
            ...
            if (1E3 < d)
                return 0;
            b = b || 0;
            var e = 0, k = t.y - 1 * s, l = t.y + 1 * s;
            if (0 <= a && a < m.length) {
                var h = q[a];
                if (0 > b && h.indexLabelTextBlock.y < k || 0 < b && h.indexLabelTextBlock.y > l)
                    return 0;
                var p = 0, n = 0, n = p = p = 0;
                ...
                n = t.x + B * Math.cos(h.midAngle);
                p = t.y + B * Math.sin(h.midAngle);
                p = Math.sqrt(Math.pow(k - n, 2) + Math.pow(b - p, 2));
                n = Math.acos(B / s);
                p = Math.acos((s * s + B * B - p * p) / (2 * B * s));
                b = p < n ? b - h.indexLabelTextBlock.y : 0;
                k = null;
                for (l = 1; l < m.length; l++)
                    if (k = (a - l + q.length) % q.length, q[k].hemisphere !== q[a].hemisphere) {
                        k = null;
                        break
                    } else if (q[k].indexLabelText && q[k].hemisphere === q[a].hemisphere && k !== a && (0 > c(q[k], q[a]) || ("right" === q[a].hemisphere ? q[k].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[k].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))
                        break;
                    else
                        k = null;
                n = k;
        ...
        function h() {
            ...
            for (var b = a = 0, d = 0, l = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                if (n.radius || !n.radius &&
                        "undefined" !== typeof n.innerRadius && null !== n.innerRadius && B - d <= E)
                    l = !1;
                l && (B -= d);
                d = 0;
                if ("inside" !== n.indexLabelPlacement) {
                    ...
                    for (var w, u, a = 0; a < m.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var z = 0, z = c(w, u) - r;
                            if (0 > z) {
                                for (var A = u = 0, D = 0; D < m.length; D++)
                                    D !== a && q[D].hemisphere === h.hemisphere &&
                                            (q[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? u++ : A++);
                                u = z / (u + A || 1) * A;
                                var A = -1 * (z - u), C = D = 0;
                    ...
                    for (a = 0; a < m.length; a++)
                        h = q[a], s = "pie" === n.type ? 0.7 * B : 0.8 * B, x = t.x + s * Math.cos(h.midAngle), u = t.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = u;
                for (a = 0; a < m.length; a++)
                    if (h = q[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width)
                        x = x = 0, "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), x *= -1) : x = e.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < x && (!l && h.indexLabelText && (u = "right" === h.hemisphere ? e.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - e.x1, 0.3 * h.indexLabelTextBlock.maxWidth > u ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * u, 0.3 * h.indexLabelTextBlock.maxWidth <
                ...
                var G = function (a, b, c) {
                    for (var d = [], e = 0; d.push(q[b]), b !== c; b = (b + 1 + m.length) % m.length)
                        ;
                    d.sort(function (a, b) {
                        return a.y - b.y
                    });
                        ...
                        if (e = !1, w = q[g], w.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > z) {
                                    ...
                                    var n = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height / 2, r = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, t = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, v = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
                                    l = w.indexLabelTextBlock.x + w.indexLabelTextBlock.width < k.indexLabelTextBlock.x - p ||
                                            l > t + p || n > v + p || r < s - p ? !1 : !0
                                }
        ...
        var k = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]], m = n.dataPoints, p = 10, e = this.plotArea, q = [], r = 2, s, v = 1.3, w = 20 / 180 * Math.PI, y = 6, t = {x: (e.x2 + e.x1) / 2, y: (e.y2 + e.y1) / 2}, u = 0;
            a = !1;
            for (var A = 0; A < m.length; A++)
                u += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0),
            ...
            if (0 !== u) {
                ...
                var B = "inside" !== n.indexLabelPlacement && a ? 0.75 * Math.min(e.width, e.height) / 2 : 0.92 * Math.min(e.width, e.height) / 2;
                n.radius && (B = Na(n.radius, B));
                var E = "undefined" !== typeof n.innerRadius && null !== n.innerRadius ? Na(n.innerRadius, B) : 0.7 * B;
                n.radius = B;
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    ...
                    b.fillRect(e.x1, e.y1, e.width, e.height);
                    a =
                            q[0].startAngle + 2 * Math.PI * a;
                    for (b = 0; b < m.length; b++) {
                        var c = 0 === b ? q[b].startAngle : d, d = c + (q[b].endAngle - q[b].startAngle), f = !1;
                        d > a && (d = a, f = !0);
                        var g = m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length];
                        d > c && Ga(k.plotArea.ctx, q[b].center, q[b].radius, g, n.type, c, d, n.fillOpacity, q[b].percentInnerRadius);
                        if (f)
                            break
                    }
                    l()
    ...
    ja.prototype.getFreeSpace = function () {
        return{x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied,
            width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied}
    };
    ...
    W.prototype.render = function (a) {
        ...
        for (b = 0; b < this._wrappedText.lines.length; b++)
            g = this._wrappedText.lines[b], "right" === this.horizontalAlign ? c = this.width - g.width - this.padding : "left" === this.horizontalAlign ?
    ...
    W.prototype._getLineWithWidth = function (a, d, b) {
        ...
        if (!a)
            return{text: "", width: 0};
        var c = b = 0, f = a.length - 1, g = Infinity;
        for (this.ctx.font = this._getFontString(); c <= f; ) {
            var g = Math.floor((c + f) / 2), h = a.substr(0, g + 1);
        ...
        d = !0;
        if (h.length === a.length || " " === a[h.length])
            d = !1;
        d && (a = h.split(" "), 1 < a.length && a.pop(), h = a.join(" "), b = this.ctx.measureText(h).width);
        return{text: h, width: b}
    };
    W.prototype._wrapText = function () {
        var a = new String(ka(String(this.text))), d = [], b = this.ctx.font, c = 0, f = 0;
        for (this.ctx.font = this._getFontString(); 0 < a.length; ) {
            var g = this.maxHeight - 2 * this.padding, h = this._getLineWithWidth(a, this.maxWidth - 2 * this.padding, !1);
            h.height = this._lineHeight;
            d.push(h);
            var l = f, f = Math.max(f, h.width), c = c + h.height, a = ka(a.slice(h.text.length, a.length));
            g && c > g && (h = d.pop(), c -= h.height, f = l)
        }
        this._wrappedText = {lines: d, width: f, height: c};
    ...
    ma.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = d.x1, c = d.y1, f =
                    0, g = 0, h = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, l, k;
            ...
            g.horizontalAlign = l;
            g.render(!0);
            a.layoutManager.registerSpace(k, {width: this.width + ("left" ===
                        k || "right" === k ? this.margin + 2 : 0), height: this.height + ("top" === k || "bottom" === k ? this.margin + 2 : 0)});
    ...
    wa.prototype.render = function () {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = null, c = 0, f = 0, g = 0, h = 0, l = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin :
                0.3 * this.fontSize;
        this.height = 0;
        var k = [], n = [];
        ...
        for (var m =
                0; m < this.dataSeries.length; m++) {
            var p = this.dataSeries[m];
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) : p.markerType, q = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({chart: this.chart, legend: this.options, dataSeries: p, dataPoint: null}) : p.name, r = p.legendMarkerColor =
                ...
                for (var u = 0; u < p.dataPoints.length; u++) {
                    var t = p.dataPoints[u], e = t.legendMarkerType ? t.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : $.getDefaultLegendMarker(p.type), q = t.legendText ? t.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({chart: this.chart, legend: this.options, dataSeries: p, dataPoint: t}) : t.name ? t.name : "DataPoint: " + (u + 1), r =
                            ...
                            Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, t, p, u), e = {markerType: e, markerColor: r, text: q, textBlock: null, chartType: p.type, markerSize: s, dataSeriesIndex: m, dataPointIndex: u, markerBorderColor: v, markerBorderThickness: w};
        ...
        if (0 < k.length) {
            p = null;
            r = u = q = t = 0;
            q = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, g) : this.itemMaxWidth = Math.min(this.itemWidth,
                    g) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, g) : this.itemMaxWidth = g;
            s = 0 === s ? 0.75 * this.lineHeight : s;
            q -= s + l;
            for (m = 0; m < k.length; m++) {
                e = k[m];
                if ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType)
                    q -= 2 * 0.1 * this.lineHeight;
                if (!(0 >= h || "undefined" === typeof h || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        e.textBlock = new W(this.ctx, {x: 0, y: 0, maxWidth: q, maxHeight: this.itemWrap ? h : this.lineHeight, angle: 0, text: e.text, horizontalAlign: "left", fontSize: this.fontSize,
                    ...
                    r = e.textBlock.width + (s + l + ("line" === e.chartType || "spline" ===
                            e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            }
            this.itemWidth = r;
            this.height = !1 === this.itemWrap ? n.length * this.lineHeight : this.height + u;
        ...
        for (m = 0; m < this.items.length; m++)
            e = k[m], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {id: e.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex};
        ...
        for (m = d = 0; m < n.length; m++) {
            ...
            for (t = u = 0; t < p.items.length; t++) {
                ...
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" ===
                        e.chartType)
                    this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(r - 0.1 * this.lineHeight, v + this.lineHeight / 2), this.ctx.lineTo(r + 0.85 * this.lineHeight, v + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
                O.drawMarker(r + s / 2, v + this.lineHeight / 2, this.ctx, e.markerType, e.markerSize, e.markerColor, e.markerBorderColor, e.markerBorderThickness);
                e.textBlock.x = r + l + s;
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" === e.chartType)
                    e.textBlock.x +=
                            0.1 * this.lineHeight;
        ...
        this.bounds = {x1: f, y1: c, x2: f + this.width, y2: c + this.height}
    };
    U(Ca, M);
    ...
    $.getDefaultLegendMarker = function (a) {
        if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a)
            return"square";
        if ("line" ===
                a || "stepLine" === a || "spline" === a || "pie" === a || "doughnut" === a || "funnel" === a)
            return"circle";
    ...
    $.prototype.getDataPointAtX = function (a, d) {
        if (!this.dataPoints || 0 === this.dataPoints.length)
            return null;
        var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, f = 0, g = 0, h = 1, l = Infinity, k = 0, n = 0, m = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (m =
                Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), m = 1 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, m = 0 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
        for (; ; ) {
            g = 0 < h ? m + f : m - f;
            if (0 <= g && g < this.dataPoints.length) {
                var c = this.dataPoints[g], p = this.axisX.logarithmic ? c.x > a ? c.x / a : a / c.x : Math.abs(c.x -
                        a);
    ...
    $.prototype.getDataPointAtXY = function (a, d, b) {
        if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2)
            return null;
        b = b || !1;
        var c = [], f = 0, g = 0, h = 1, l = !1, k = Infinity, n = 0, m = 0, p = 0;
        "none" !==
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "rangeColumn":
                        case "rangeBar":
                            a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (c.push({dataPoint: q, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y1 - d), Math.abs(e.y2 - d))}),
                                    l = !0);
                            break;
                        case "line":
                        case "stepLine":
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = L("markerSize", q, this) || 4, v = b ? 20 : s, r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            r <= v && c.push({dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r});
                            g = Math.abs(e.x1 - a);
                            g <= k ? k = g : 0 < h ? n++ : m++;
                            r <= s / 2 && (l = !0);
                            break;
                        ...
                        case "rangeSplineArea":
                            s = L("markerSize", q, this) || 4;
                            v = b ? 20 : s;
                            r = Math.min(Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 -
                        ...
                        case "bubble":
                            s = e.size;
                            r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            r <= s / 2 && (c.push({dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r}), l = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
                        ...
                        case "candlestick":
                            if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && d >= e.y2 - e.borderThickness / 2 && d <=
                                    e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y1 && d <= e.y4)
                                c.push({dataPoint: q, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - d), Math.abs(e.y3 - d))}), l = !0;
                            break;
                        case "ohlc":
                            if (Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y2 && d <= e.y3 || a >= e.x1 && a <= (e.x2 + e.x1) / 2 && d >= e.y1 - e.borderThickness / 2 && d <= e.y1 + e.borderThickness / 2 || a >= (e.x1 + e.x2) / 2 && a <= e.x2 && d >= e.y4 - e.borderThickness / 2 && d <= e.y4 + e.borderThickness / 2)
                                c.push({dataPoint: q,
                                    dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - d), Math.abs(e.y3 - d))}), l = !0
                    }
                    if (l || 1E3 < n && 1E3 < m)
                        break
                }
            } else if (0 > p - f && p + f >= this.dataPoints.length)
                break;
            -1 === h ? (f++, h = 1) : h = -1
        }
        a = null;
    ...
    $.prototype.getMarkerProperties = function (a, d, b, c) {
        ...
        return{x: d, y: b, ctx: c, type: f[a].markerType ? f[a].markerType : this.markerType, size: f[a].markerSize ? f[a].markerSize : this.markerSize,
    ...
    B.prototype.createExtraLabelsForLog = function (a) {
        ...
        if (!(5 < a)) {
            ...
            if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                for (var b = B.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < d; c += b)
    ...
    B.prototype.createLabels = function () {
        var a, d, b = 0, c = 0, f, g = 0, h = 0, c = 0, l = this.interval, k = 0, n, m = 0.6 * this.chart.height, b = !1;
        if (this.dataSeries &&
                0 < this.dataSeries.length)
            for (c = 0; c < this.dataSeries.length; c++)
                "dateTime" === this.dataSeries[c].xValueType && (b = !0);
        if ("axisX" === this.type && b && !this.logarithmic)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), f = Ha(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ha(b, l, this.intervalType))
                a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.options, value: b,
                    ...
                    fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"}), this._labels.push({position: b.getTime(), textBlock: a, effectiveHeight: null});
        else {
            ...
            for (b = this.intervalStartPosition; b <= f; b = parseFloat((this.logarithmic && this.equidistantInterval?b * Math.pow(this.logarithmBase, this.interval):
                ...
                a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null}) : "axisX" === this.type && this.labels[b] ? this.labels[b] : da(b, this.valueFormatString, this.chart._cultureInfo), a = new W(this.ctx, {x: 0, y: 0, maxWidth: g, maxHeight: h, angle: this.labelAngle, text: this.prefix + a + this.suffix, horizontalAlign: "left", backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness,
                    cornerRadius: this.labelCornerRadius, fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"}), this._labels.push({position: b, textBlock: a, effectiveHeight: null})
        }
        if ("bottom" === this._position || "top" === this._position)
            k = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length -
            ...
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
                ...
                if (g = 0.9 * k >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++) {
                        ...
                        for (var r, s = a.text.split(" "), c = 0; c < s.length; c++)
                            e = s[c], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > p && (r = b, p = e.width)
                    }
                    b = 0;
                    for (b = this.intervalStartPosition < this.viewportMinimum?1:0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
                            ...
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), s = (m - (n + a.fontSize / 2) *
                                ...
                                if (x(this.options.labelWrap))
                                    if (!x(this.options.labelMaxWidth))
                                        this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = c) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = h);
                                    else if (!x(d))
                                        if (c = q.width + d.width >> 0, e = this.labelFontSize, p < g)
                                            c - 2 * g > l && (l = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth =
                                        ...
                                        else if (r === b && (0 === r && p + this._labels[r + 1].textBlock.measureText().width - 2 * g > l || r === this._labels.length - 1 && p + this._labels[r -
                                        1].textBlock.measureText().width - 2 * g > l || 0 < r && r < this._labels.length - 1 && p + this._labels[r + 1].textBlock.measureText().width - 2 * g > l && p + this._labels[r - 1].textBlock.measureText().width - 2 * g > l))
                                            l = 0 === r ? p + this._labels[r + 1].textBlock.measureText().width - 2 * g : p + this._labels[r - 1].textBlock.measureText().width - 2 * g, this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth =
                                                    s;
                                        else if (0 === l)
                                            for (this.sessionVariables.labelFontSize = x(this.options.labelFontSize)?e:this.options.labelFontSize, this.sessionVariables.labelWrap = !0, c = 0; c < this._labels.length; c++)
                    ...
                    for (c = 0; c < this._labels.length; c++)
                        a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth,
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = x(this.options.labelFontSize) ? this.sessionVariables.labelFontSize :
                ...
                if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, h = "undefined" === typeof this.options.labelWrap || this.labelWrap ?
                    ...
                    this.sessionVariables.labelWrap = this.labelWrap;
                    for (b = 0; b < this._labels.length; b++)
                        (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock,
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this.options.labelMaxWidth) ?
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === g.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    v = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                if ("left" === this._position || "right" === this._position)
                    v = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
            ...
            a = new W(this.ctx, {x: 0, y: 0, backgroundColor: d, borderColor: g.labelBorderColor,
    ...
    B.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (d = 0; d < this._labels.length; d++) {
                var b = this._labels[d].textBlock, c = b.measureText(), f = 0, f = 0 === this.labelAngle ? c.width : c.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (c.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                a < f && (a = f);
                this._labels[d].effectiveWidth = f
            }
            for (d = 0; d < this._stripLineLabels.length; d++)
                "outside" === this._stripLineLabels[d].stripLine.labelPlacement && (this._stripLineLabels[d].stripLine.value >
    ...
    B.prototype.createLabelsAndCalculateHeight = function () {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) {
                ...
                var c = d.measureText(), f = 0, f = 0 === this.labelAngle ? c.height : c.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (c.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                a < f && (a = f);
    ...
    B.setLayoutAndRender = function (a, d, b, c, f, g) {
        var h, l, k, n, m = a[0] ? a[0].chart : d[0].chart, p = m.ctx;
        if (a && 0 < a.length)
            for (var e = 0; e < a.length; e++)
                a[e] && a[e].calculateAxisParameters();
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e].calculateAxisParameters();
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e].calculateAxisParameters();
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e].calculateAxisParameters();
        var q = 0, r = 0, s = 0, v = 0, w = 0, u = 0, t = 0, z, A, B = l = 0, E, F, G, J;
        E = F = G = J = !1;
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e] && a[e].title && (a[e]._titleTextBlock = new W(a[e].ctx, {text: a[e].title, horizontalAlign: "center", fontSize: a[e].titleFontSize, fontFamily: a[e].titleFontFamily, fontWeight: a[e].titleFontWeight,
        ...
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e] && d[e].title && (d[e]._titleTextBlock = new W(d[e].ctx, {text: d[e].title, horizontalAlign: "center", fontSize: d[e].titleFontSize, fontFamily: d[e].titleFontFamily, fontWeight: d[e].titleFontWeight, fontColor: d[e].titleFontColor, fontStyle: d[e].titleFontStyle,
                    borderColor: d[e].titleBorderColor, borderThickness: d[e].titleBorderThickness, backgroundColor: d[e].titleBackgroundColor, cornerRadius: d[e].titleCornerRadius, textBaseline: "top"}));
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e] && b[e].title && (b[e]._titleTextBlock = new W(b[e].ctx, {text: b[e].title, horizontalAlign: "center", fontSize: b[e].titleFontSize, fontFamily: b[e].titleFontFamily, fontWeight: b[e].titleFontWeight, fontColor: b[e].titleFontColor, fontStyle: b[e].titleFontStyle, borderColor: b[e].titleBorderColor, borderThickness: b[e].titleBorderThickness,
        ...
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e] && c[e].title && (c[e]._titleTextBlock = new W(c[e].ctx, {text: c[e].title, horizontalAlign: "center", fontSize: c[e].titleFontSize, fontFamily: c[e].titleFontFamily, fontWeight: c[e].titleFontWeight, fontColor: c[e].titleFontColor, fontStyle: c[e].titleFontStyle, borderColor: c[e].titleBorderColor, borderThickness: c[e].titleBorderThickness, backgroundColor: c[e].titleBackgroundColor,
                    cornerRadius: c[e].titleCornerRadius, textBaseline: "top"}));
        if ("normal" === f) {
            var v = [], w = [], u = [], t = [], H = [], I = [], M = [], K = [];
            if (a && 0 < a.length)
                for (e = 0; e < a.length; e++)
                    a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle = 0);
            if (d && 0 < d.length)
                for (e = 0; e < d[e].length; e++)
                    d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ?
                            0.8 * g.height : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle = 0);
            if (b && 0 < b.length)
                for (e = 0; e < b.length; e++)
                    b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.height, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.width : 1.5 * b[e].titleFontSize, b[e]._titleTextBlock.angle = -90);
            if (c && 0 < c.length)
                for (e = 0; e < c.length; e++)
                    c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.height, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.width : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle =
                            90);
            for (; 4 > q; ) {
                var N = 0, Q = 0, O = 0, P = 0, L = f = 0, C = 0, S = 0, X = 0, V = 0, U = 0, T = 0;
                if (b && 0 < b.length)
                    for (u = [], e = U = 0; e < b.length; e++)
                        u.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), U += u[e], C += b[e] ? b[e].margin : 0;
                else
                    u.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                M.push(u);
                if (c && 0 < c.length)
                    for (t = [], e = T = 0; e < c.length; e++)
                        t.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), T += t[e], S += c[e] ? c[e].margin : 0;
                else
                    t.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                K.push(t);
                h = Math.round(g.x1 + U + C);
                k = Math.round(g.x2 - T - S > m.width - 10 ? m.width - 10 : g.x2 - T - S);
                if (a && 0 < a.length)
                    for (v = [], e = X = 0; e < a.length; e++)
                        a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(k - h), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width), v.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += v[e], f += a[e] ? a[e].margin : 0;
                else
                    v.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                            0));
                H.push(v);
                if (d && 0 < d.length)
                    for (w = [], e = V = 0; e < d.length; e++)
                        d[e] && (d[e].lineCoordinates = {}), d[e].lineCoordinates.width = Math.abs(k - h), d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width), w.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)), V += w[e], L += d[e] ? d[e].margin : 0;
                else
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++)
                        d[e].lineCoordinates.x1 = Math.round(g.x1 + U + C), d[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > m.width - 10 ? m.width - 10 : g.x2 - T - S), d[e].lineCoordinates.width = Math.abs(k - h), d[e]._labels && 1 < d[e]._labels.length && (n = d[e]._labels[1], l = "dateTime" === d[e].chart.plotInfo.axisXValueType ? d[e]._labels[d[e]._labels.length - 2] : d[e]._labels[d[e]._labels.length - 1], r = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) +
                            ...
                            h, height: n - l}, Q += w[e] + d[e].margin;
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, l = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, n = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {x1: k - O, y1: l, x2: k - O, y2: n, height: Math.abs(n -
                                    l)}, b[e].bounds = {x1: h - (u[e] + O), y1: l, x2: k, y2: n, width: k - h, height: n - l}, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), O += u[e] + b[e].margin);
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++)
                        c[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(h), C = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[c[e]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + V + L < Math.max(C,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++)
                        a[e] && (a[e].calculateValueToPixelConversionParameters(),
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++)
                        d[e].calculateValueToPixelConversionParameters(), d[e]._labels && 1 < d[e]._labels.length && (z =
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        b[e].calculateValueToPixelConversionParameters();
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++)
            ...
            if (a && 0 <
                    a.length)
                for (e = 0; e < a.length; e++)
                    a[e].renderLabelsTicksAndTitle();
            if (d && 0 < d.length)
                for (e = 0; e < d.length; e++)
                    d[e].renderLabelsTicksAndTitle();
            p.restore();
            if (b && 0 < b.length)
                for (e = 0; e < b.length; e++)
                    b[e].renderLabelsTicksAndTitle();
            if (c && 0 < c.length)
                for (e = 0; e < c.length; e++)
                    c[e].renderLabelsTicksAndTitle()
        } else {
            z = [];
            A = [];
            B = [];
            ...
            if (a && 0 < a.length)
                for (e = 0; e < a.length; e++)
                    a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ?
                            0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle = -90);
            if (d && 0 < d.length)
                for (e = 0; e < d.length; e++)
                    d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ? 0.8 * g.height : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle = 90);
            if (b && 0 < b.length)
                for (e = 0; e < b.length; e++)
                    b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.width, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.height : 1.5 * b[e].titleFontSize, b[e]._titleTextBlock.angle =
                            0);
            if (c && 0 < c.length)
                for (e = 0; e < c.length; e++)
                    c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.height : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 0);
            for (; 4 > q; ) {
                V = X = U = P = S = C = L = f = O = K = Q = N = 0;
                if (a && 0 < a.length)
                    for (B = [], e = X = 0; e < a.length; e++)
                        B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)), X += B[e], f += a[e] ? a[e].margin : 0;
                else
                    B.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                I.push(B);
                if (d && 0 < d.length)
                    for (r =
                    [], e = V = 0; e < d.length; e++)
                        r.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), V += r[e], L += d[e] ? d[e].margin : 0;
                else
                    r.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                M.push(r);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > m.width - 10 ? m.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(v) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, v) : 0 === b[e].labelAngle ? Math.max(h, v / 2) : h), 0 < !d.length && (k = 0 < b[e].labelAngle ? k - w / 2 : 0 === b[e].labelAngle ?
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++)
                        c[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > c[e].chart.width - 10 ? c[e].chart.width - 10 : g.x2 - V - L), c[e] && c[e].labelAutoFit && !x(u) && (0 < !a.length && (h = 0 < c[e].labelAngle ? Math.max(h, u) :
                ...
                if (b && 0 < b.length)
                    for (z = [], e = P = 0; e < b.length; e++)
                        z.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), P += z[e] + b[e].margin, C += b[e].margin;
                else
                    z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() :
                            0));
                s.push(z);
                if (c && 0 < c.length)
                    for (A = [], e = U = 0; e < c.length; e++)
                        A.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)), U += A[e], S += c[e].margin;
                else
                    A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                H.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++)
                        0 < b[e]._labels.length && (n = b[e]._labels[0], l = b[e]._labels[b[e]._labels.length - 1], v = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) + (n.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(n.textBlock.angle)),
                ...
                if (m.panEnabled)
                    for (e = 0; e < b.length; e++)
                        z[e] = m.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++)
                        m.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--)
                        l = Math.round(g.y2), n = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = l - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = l - (z[e] + b[e].margin + N), b[e].bounds = {x1: h, y1: l - (z[e] + N + b[e].margin),
                            x2: k, y2: n - (N + b[e].margin), width: k - h, height: z[e]}, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width), N += z[e] + b[e].margin;
                if (c && 0 < c.length)
                    for (e = c.length - 1; 0 <= e; e--)
                        c[e] && (l = Math.round(g.y1), n = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = n, c[e].lineCoordinates.y2 = n, c[e].bounds = {x1: h, y1: l + (c[e].margin + Q), x2: k, y2: n, width: k - h, height: U}, c[e].title && (c[e]._titleTextBlock.maxWidth = 0 <
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        n = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - P > m.height -
                                Math.max(C, 10) ? m.height - Math.max(C, 10) : g.y2 - P) : g.y2 > m.height - Math.max(C, 10) ? m.height - Math.max(C, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++)
                                b[C] && b[C].labelAutoFit && (k = 0 > b[C].labelAngle ? Math.max(k, v) : 0 === b[C].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - X : h);
                        if (c && 0 < c.length)
                            for (C = 0; C < c.length; C++)
                                c[C] && c[C].labelAutoFit && (k = c[C].lineCoordinates.x1, h = k - X);
                        a[e].lineCoordinates = {x1: k - K, y1: l, x2: k - K, y2: n, height: Math.abs(n - l)};
                        a[e].bounds = {x1: k - (B[e] + K), y1: l, x2: k, y2: n, width: k -
                            h, height: n - l};
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) {
                        ...
                        n = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - P > m.height - Math.max(C, 10) ? m.height - Math.max(C, 10) : g.y2 - P) : g.y2 > m.height - Math.max(C, 10) ? m.height - Math.max(C, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++)
                                b[C] && b[C].labelAutoFit && (k = 0 > b[e].labelAngle ? Math.max(k, v) : 0 === b[e].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - V : h);
                        if (c && 0 < c.length)
                            for (C = 0; C < c.length; C++)
                                c[C] && c[C].labelAutoFit && (k = c[C].lineCoordinates.x2, h = k - V);
                        d[e].lineCoordinates =
                                {x1: k + O, y1: l, x2: k + O, y2: n, height: Math.abs(n - l)};
                        d[e].bounds = {x1: h, y1: l, x2: k + r[e] + O, y2: n, width: k - h, height: n - l};
        ...
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e].renderStripLinesOfThicknessType("value");
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e].renderStripLinesOfThicknessType("value");
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e].renderStripLinesOfThicknessType("value");
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e].renderStripLinesOfThicknessType("value");
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e].renderInterlacedColors();
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e].renderInterlacedColors();
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e].renderInterlacedColors();
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e].renderInterlacedColors();
        p.restore();
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e].renderGrid();
        ...
        if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
                a[e].renderStripLinesOfThicknessType("pixel");
        if (d && 0 < d.length)
            for (e = 0; e < d.length; e++)
                d[e].renderStripLinesOfThicknessType("pixel");
        if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
                b[e].renderStripLinesOfThicknessType("pixel");
        if (c && 0 < c.length)
            for (e = 0; e < c.length; e++)
                c[e].renderStripLinesOfThicknessType("pixel")
    };
    B.prototype.renderLabelsTicksAndTitle = function () {
        var a = !1, d = 0, b = 0, c = 1, f = 0;
        ...
        if ("undefined" === typeof this.options.interval) {
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var d = [], c = 0 !== this.labelAngle &&
                        ...
                        if (m.position < this.viewportMinimum)
                            break;
                        m.position > this.viewportMaximum || !(k === this._labels.length - 1 || g < Math.log(h / m.position) * l / c) || (d.push(m), h = m.position, g = m.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = d
                } else {
                    for (k = 0; k < this._labels.length; k++)
                        m =
                                this._labels[k], m.position < this.viewportMinimum || (m = m.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), d += m);
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    ...
                    for (k = 0; k < this._labels.length; k++)
                        m = this._labels[k], m.position < this.viewportMinimum || (m = m.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.width * Math.abs(Math.sin(Math.PI /
                                180 * this.labelAngle)), b += m);
                    b > this.lineCoordinates.height * c && this.labelAutoFit && (a = !0)
                }
        }
        if ("bottom" === this._position) {
            for (var m, k = 0; k < this._labels.length; k++)
            ...
            for (k = 0; k < this._labels.length; k++)
                m = this._labels[k], m.position < this.viewportMinimum || m.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(m.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
                        ...
                        180 * this.labelAngle) + (0 < this.labelAngle ? m.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))), m.textBlock.x = b.x, m.textBlock.y = b.y, m.textBlock.render(!0)));
            ...
            for (k = 0; k < this._labels.length; k++)
                m = this._labels[k], m.position < this.viewportMinimum || m.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(m.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, c = 1 === this.ctx.lineWidth %
    ...
    B.prototype.renderInterlacedColors = function () {
        var a = this.chart.plotArea.ctx, d, b, c = this.chart.plotArea, f = 0;
        d = !0;
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor,
                    f = 0; f < this._labels.length; f++)
                d ? (d = this.getPixelCoordinatesOnAxis(this._labels[f].position), b = f + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position), a.fillRect(Math.min(b.x, d.x), c.y1, Math.abs(b.x - d.x), Math.abs(c.y1 - c.y2)), d = !1) : d = !0;
        else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, f = 0; f < this._labels.length; f++)
                d ? (b = this.getPixelCoordinatesOnAxis(this._labels[f].position),
    ...
    B.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var d = this, b, c = 0, f = 0, g = !1, h = !1, l = [], k = [], h = !1, c = 0; c < this.stripLines.length; c++) {
                ...
                n._thicknessType === a && ("pixel" === a && (n.value < this.viewportMinimum ||
                        n.value > this.viewportMaximum || isNaN(this.range)) || l.push(n))
            }
            for (c = 0; c < this._stripLineLabels.length; c++)
                if (n = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                    ...
                    if ("outside" === b.stripLine.labelPlacement)
                        if (n && (this.ctx.strokeStyle = n.color, "pixel" === n._thicknessType && (this.ctx.lineWidth = n.thickness)), "bottom" === this._position) {
                            var m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x <<
                                    0;
                            this.ctx.beginPath();
                            ...
                            "top" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(m,
            ...
            if (!h) {
                ...
                for (c = 0; c < l.length; c++)
                    n = l[c], n.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                        this.ctx.save();
                        this.ctx.beginPath();
                        this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                        this.ctx.clip();
                        for (f = 0; f < l.length; f++)
                            n = l[f], n.showOnTop && n.render();
                        this.ctx.restore()
                    }, n)) : n.render();
                for (c = 0; c < k.length; c++)
                    b = k[c], b.stripLine.showOnTop ?
                            h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                                for (f = 0; f < k.length; f++)
                                    b = k[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), b.textBlock.render(!0), d.ctx.restore())
                            }, b.textBlock)) : "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
                this.ctx.restore();
                h = !0
            }
            if (h)
                for (h = !1, c = 0; c < k.length; c++)
                    b = k[c], b.stripLine.showOnTop ?
                            h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                                for (f = 0; f < k.length; f++)
                                    b = k[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0)
    ...
    B.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                for (c = 0; c < this._labels.length; c++)
                    this._labels[c].position < this.viewportMinimum || this._labels[c].position > this.viewportMaximum || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[c].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, b.y1 << 0), a.lineTo(d, b.y2 << 0), a.stroke());
            else if ("left" === this._position || "right" === this._position)
    ...
    B.prototype.renderAxisLine = function () {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            "left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(I(this.lineDashType, this.lineThickness)), d = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 <<
    ...
    B.prototype.calculateValueToPixelConversionParameters = function (a) {
        ...
        var d = this.lineCoordinates.width, b = this.lineCoordinates.height;
        a.minimum = this.viewportMinimum;
        if ("bottom" === this._position || "top" === this._position)
            this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? -1 : 1) * d * a.lnLogarithmBase / Math.log(Math.abs(this.range))) : a.pixelPerUnit =
                    (this.reversed ? -1 : 1) * d / Math.abs(this.range), a.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
        if ("left" === this._position || "right" === this._position)
            this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? 1 : -1) * b * a.lnLogarithmBase / Math.log(Math.abs(this.range))) : a.pixelPerUnit = (this.reversed ? 1 : -1) * b / Math.abs(this.range), a.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
                ...
                if (this.logarithmic)
                    ...
                    if ("axisX" === this.type) {
                        if (this.dataSeries && 0 < this.dataSeries.length)
                            for (f = 0; f < this.dataSeries.length; f++)
                                "dateTime" === this.dataSeries[f].xValueType && (b = !0);
                        ...
                        "axisY" === this.type && (f = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, g = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, isFinite(f) || isFinite(g) ? isFinite(f) ? isFinite(g) || (g = f) : f = g : (g = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                    ...
                    if (null === this.minimum || null === this.maximum)
                        if ("axisX" === this.type ? (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === g - f && (c = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, g += c, f -= c), h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1) : "axisY" === this.type && (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(f) ||
                            ...
                            this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? f - h / 2 : Math.floor(f / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
    ...
    B.prototype.calculateLogarithamicAxisParameters = function () {
        ...
        "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width);
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth / 100)) : Math.max(Math.floor(this.maxWidth / 50), 3), c, f, g, h;
        h = 1;
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            this.viewportMinimum =
                    this.minimum;
        ...
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum = "axisX" === this.type ? f * Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(f) / d /
                    this.interval));
    ...
    B.prototype.getLabelStartPoint = function () {
        var a = E[this.intervalType + "Duration"] * this.interval, a = new Date(Math.floor(this.viewportMinimum / a) * a);
        if ("millisecond" !== this.intervalType)
            if ("second" === this.intervalType)
                ...
                "year" === this.intervalType && (0 < a.getMonth() || 1 < a.getDate() || 0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds()) && (a.setFullYear(a.getFullYear() + 1), a.setMonth(0),
    ...
    na.prototype.render = function () {
        ...
        if (0 < d) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)
                f =
                        g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = {x1: f - d / 2, y1: h, x2: g + d / 2, y2: l};
            else if ("left" === this.parent._position || "right" === this.parent._position)
                h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = {x1: f, y1: h - d / 2, x2: g, y2: l + d / 2};
            this.ctx.moveTo(f, h);
            this.ctx.lineTo(g, l);
            this.ctx.stroke();
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var l =
                            ...
                            for (var h = this.chart.axisX[l].convertPixelToValue({y: d}), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)
                                (k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (l = 0; l < this.chart.axisX2.length; l++) {
                            ...
                            for (c = 0; c < this.chart.axisX2[l].dataSeries.length; c++)
                                (k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h,
                    ...
                    if (this.chart.axisX)
                        for (l = 0; l < this.chart.axisX.length; l++)
                            for (h = this.chart.axisX[l].convertPixelToValue({x:a}), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)
                                (k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                    if (this.chart.axisX2)
                        for (l = 0; l < this.chart.axisX2.length; l++)
                            for (h =
                                    this.chart.axisX2[l].convertPixelToValue({x:a}), k = null, c = 0; c < this.chart.axisX2[l].dataSeries.length; c++)
                                (k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[l].dataSeries[c], null !== k.dataPoint.y && f.push(k))
                }
                if (0 === f.length)
                    return;
                f.sort(function (a, b) {
                ...
                for (c = 0; c < f.length; c++)
                    f[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() && g.push(f[c]);
                f = null
            } else {
                if (k = this.chart.getDataPointAtXY(a, d, b))
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex)
                        c = f.dataPoints[this.currentDataPointIndex], k.dataSeries = f, k.dataPoint = c, k.index = this.currentDataPointIndex, k.distance = Math.abs(c.x - h);
                    else {
                        if (!this.enabled || "line" !== f.type && "stepLine" !== f.type && "spline" !== f.type && "area" !== f.type && "stepArea" !== f.type && "splineArea" !== f.type && "stackedArea" !== f.type && "stackedArea100" !== f.type && "rangeArea" !== f.type && "rangeSplineArea" !== f.type && "candlestick" !== f.type && "ohlc" !== f.type)
                            return;
                        h = f.axisX.convertPixelToValue({x: a});
                    ...
                    if (!x(k.dataPoint.y))
                        if (k.dataSeries.axisY)
                            if (0 < k.dataPoint.y.length) {
                                ...
                                "column" === f.type || "bar" === f.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && g.push(k) : k.dataSeries.axisY.viewportMinimum <=
    ...
    S.prototype.highlightObjects = function (a) {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) &&
                ...
                var c = this.chart.data[f.dataSeriesIndex], g = c.dataPoints[f.dataPointIndex], h = f.dataPointIndex;
    ...
    S.prototype.getToolTipInnerHTML = function (a) {
        var d = a.entries, b = null, c = null, f = null, g = 0;
        a = "";
        ...
        if (h && (this.content && "function" === typeof this.content ||
            ...
            d = {chart: this.chart, toolTip: this.options, entries: d}, b = this.contentFormatter ? this.contentFormatter(d) : this.content(d);
        else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
            for (var k = null, n = "", l = 0; l < d.length; l++)
                if (c = d[l].dataSeries, f = d[l].dataPoint, g = d[l].index, a = "", 0 === l && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? n += "undefined" !== typeof this.chart.axisX[0].labels[f.x] ? this.chart.axisX[0].labels[f.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length &&
                        (n += "undefined" !== typeof this.chart.axisX2[0].labels[f.x] ? this.chart.axisX2[0].labels[f.x] : "{x}"), n += "</br>", n = this.chart.replaceKeywordsWithValue(n, f, c, g)), null !== f.toolTipContent && ("undefined" !== typeof f.toolTipContent || null !== c.options.toolTipContent)) {
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" ===
                        ...
                        this.chart.axisX && 1 < this.chart.axisX.length &&
                        ...
                        this.chart.axisX && 1 < this.chart.axisX.length && (a += k != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" :
            ...
            f = d[0].dataPoint;
            g = d[0].index;
            if (null === f.toolTipContent || "undefined" === typeof f.toolTipContent && null === c.options.toolTipContent)
                return null;
            if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" ===
                    c.type || "stackedArea100" === c.type)
                a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === c.type)
                a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") +
                        "\"'>" + (f.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            else if ("pie" === c.type || "doughnut" === c.type || "funnel" === c.type)
                a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.name ? "{name}:</span>&nbsp;&nbsp;" : f.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}";
            else if ("rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type ||
                    "rangeSplineArea" === c.type)
                a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === c.type || "ohlc" === c.type)
                a = f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ?
                        "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
            null === b && (b = "");
            b += this.chart.replaceKeywordsWithValue(a, f, c, g)
        }
        this.content = a;
        for (l = 0; l < this.chart.data.length; l++)
            this.chart.data[l].toolTipContent = this.content;
        return b
    };
    S.prototype.enableAnimation = function () {
        this.container.style.WebkitTransition || (this.container.style.WebkitTransition = "left .2s ease-out, bottom .2s ease-out",
                this.container.style.MozTransition = "left .2s ease-out, bottom .2s ease-out", this.container.style.MsTransition = "left .2s ease-out, bottom .2s ease-out", this.container.style.transition = "left .2s ease-out, bottom .2s ease-out")
    };
    ...
    A.prototype.getPercentAndTotal = function (a, d) {
        ...
        if (0 <= a.type.indexOf("stacked"))
            c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], f = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c));
        else if ("pie" === a.type || "doughnut" ===
                a.type) {
            for (i = c = 0; i < a.dataPoints.length; i++)
                isNaN(a.dataPoints[i].y) || (c += a.dataPoints[i].y);
            f = isNaN(d.y) ? 0 : 100 * (d.y / c)
        }
        return{percent: f, total: c}
    };
    A.prototype.replaceKeywordsWithValue = function (a, d, b, c, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var h = "#percent", l = "#total", k = this.getPercentAndTotal(b, d), l = isNaN(k.total) ? l : k.total, h = isNaN(k.percent) ? h : k.percent;
            do {
                k = "";
                if (b.percentFormatString)
                    k =
                            b.percentFormatString;
                else {
                    var k = "#,##0.", n = Math.max(Math.ceil(Math.log(1 / Math.abs(h)) / Math.LN10), 2);
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            if ('"' === a[0] && '"' === a[a.length - 1] || "'" === a[0] && "'" === a[a.length -
            1])
                return a.slice(1, a.length - 1);
            ...
            h = null;
            if ("color" === a)
                return d.color ? d.color : b.color ? b.color : b._colorSet[c % b._colorSet.length];
            ...
            if ("x" === a)
                if ("dateTime" === g.plotInfo.axisXValueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {
                    if (g.plotInfo.plotTypes[0].plotUnits[0].axisX &&
                        ...
                        return Ea(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : "DD MMM YY", g._cultureInfo)
                } else
                    return da(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo);
            else
                return"y" === a ? da(h, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ?
                        b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" === a ? da(h, d.zValueFormatString ? d.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
        })
    };
    ...
    la.prototype.getNewObjectTrackingId =
            function () {
        ...
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c])
                if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                    var f = this.chart.data[c.dataSeriesIndex], g = f.dataPoints[c.dataPointIndex], h = c.dataPointIndex;
                    c.eventParameter = {x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: h, dataSeriesIndex: f.index, chart: this.chart};
                    c.eventContext =
                            {context: g, userContext: g, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click"};
                    d.push(c);
                    c = this.objectMap[f.id];
                    c.eventParameter = {x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: h, dataSeriesIndex: f.index, chart: this.chart};
                    c.eventContext = {context: f, userContext: f.options, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click"};
                    d.push(this.objectMap[f.id])
                } else
                    "legendItem" === c.objectType && (f = this.chart.data[c.dataSeriesIndex], g = null !== c.dataPointIndex ?
    ...
    la.prototype.fireEvent = function (a, d, b) {
        if (a && d) {
            var c =
                    a.eventParameter, f = a.eventContext, g = a.eventContext.userContext;
    ...
    Da.prototype.animate = function (a, d, b, c, f) {
        ...
        for (a = []; 0 < this.animations.length; )
            if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = f(Math.min(b - d.startTime, d.duration), 0, 1, d.duration), c = Math.min(c, 1), isNaN(c) || !isFinite(c)) && (c = 1), 1 > c && a.push(d), d.animationCallback(c), 1 <= c && d.onComplete)
                d.onComplete();
        this.animations = a;
    ...
    var F = {yScaleAnimation: function (a, d) {
            if (0 !== a) {
                var b = d.dest, c = d.source.canvas, f = d.animationBase;
            ...
            if (0 !== a) {
                var b = d.dest, c = d.source.canvas, f = d.animationBase;
                b.drawImage(c, 0, 0, c.width, c.height, f - f * a, 0, a * b.canvas.width / Q, b.canvas.height / Q)
            }
            ...
            }}}, O = {drawMarker: function (a, d, b, c, f, g, h, l) {
            if (b) {
                var k = 1;
                b.fillStyle = g ? g : "#000000";
                b.strokeStyle = h ? h : "#000000";
                b.lineWidth = l ? l : 0;
                "circle" === c ? (b.moveTo(a, d), b.beginPath(), b.arc(a, d, f / 2, 0, 2 * Math.PI, !1), g && b.fill(), l && (h ? b.stroke() : (k = b.globalAlpha, b.globalAlpha =
                        ...
                        f / 4, b.beginPath(), b.moveTo(a - f / 2, d - f / 2), b.lineTo(a + f / 2, d + f / 2), b.stroke(), b.moveTo(a + f / 2, d - f / 2), b.lineTo(a - f / 2, d + f / 2), b.stroke())
            }
        ...
        }}, Oa = {Chart: A, addColorSet: function (a, d) {
            ha[a] = d
            ...
            b = b || "en";
            if (pa[b])
                return da(a, d || "#,##0.##", new oa(b));
            throw"Unknown Culture Name";
        }, formatDate: function (a,
                d, b) {
            b = b || "en";
            if (pa[b])
                return Ea(a, d || "DD MMM YYYY", new oa(b));
            throw"Unknown Culture Name";
        }};
    Oa.Chart.version = "v1.9.7 GA";
    window.CanvasJS = Oa
})();
/*
